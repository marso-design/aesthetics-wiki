...
Trope, when used in the context of the wiki, refers to the use by TVTropes and cinematography, where, "a universally identified image imbued with several layers of contextual meaning creating a new visual metaphor" is included in a work of fiction. Like genre fiction, a trope is not inherently an aesthetic. In the context of this wiki, "trope" typically refers to a [setting](https://en.wikipedia.org/wiki/Setting_(narrative)) or a [stock character](https://en.wikipedia.org/wiki/Stock_character), which are types of tropes that may have very identifiable and consistent visual designs.
