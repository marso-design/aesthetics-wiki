...
_Also known as: Stilyaga (singular)_
...
**Reason for Warning:** This page documents a subculture associated with political persecution (state suppression, arrests, expulsion from university), illegal activities (black market trading, illegal music production), and substance use (alcohol, smoking). Reader discretion is advised.

**Stilyagi** (Russian: стиляги), meaning "style hunters," were members of a youth subculture in the Soviet Union from the late-1940s to the early-1960s, primarily based in large cities. They were young adults who imitated American and Western lifestyles, particularly in fashion, music, and dance. The term "*stilyagi*" originated from the satirical magazine Krokodil in 1949, where it was used to ridicule Soviet youth who imitated the [Teddy Boys](https://aesthetics.fandom.com/wiki/Teddy_Boys "Teddy Boys") of the United Kingdom. Some stilyagi, known as "*shtatniki*," exclusively wore American clothing brands.
...
By the early 1960s, the pressure on the Stilyagi lessened, partly due to the subculture fading away as its members grew older and many Western cultural elements became more accepted in Soviet society. The rise of new youth movements like British Invasion/Beatlemania and the [hippie](https://aesthetics.fandom.com/wiki/Hippie "Hippie") counterculture further contributed to the decline of the Stilyagi.
...
An anti-Stilyagi propaganda poster from the 1950s. It translates to "a sold soul."

This newspaper's headline translates to “Today he dances jazz, tomorrow he will sell his homeland.”

Moscow Youth Festival (1957)

The Moscow Youth Festival of 1957 was a turning point for Soviet society, with Western influence becoming more apparent. This marked the decline of the subculture.
...
Both men and women incorporated accessories like American playing cards with [pin-up](https://aesthetics.fandom.com/wiki/Pin-up "Pin-up") girls, trophy lighters and cigarette cases, and imported pens, which were considered luxury items in the Soviet Union. By the 1960s, elements of the rock and roll look were also integrated.
...
* **Baruch (Барух) (borhu (борху))**: A girl with liberal views on relationships with men.
* **Baton (Батон)**: A regular girl, not a Stilyaga, who attends Stilyagi gatherings.
* **Broadway (Бродвей) or Brod (Брод)**: The main street of a city, serving as a meeting point for Stilyagi. Each city had its own "Broadway," such as Gorky Street (now Tverskaya) in Moscow and Nevsky Prospekt in Leningrad.
* **Chucha (Чуча)**: The song "Chattanooga Choo Choo," popularized by the American film "*Sun Valley Serenade*."
* **Chuvikha (Чувиха) (chuvava (чувава), chuvirla (чувирла))**: A female Stilyaga.
* **Drinking (Дринкать)**: To drink alcohol.
* **Dusman (Дусман)**: A fellow Stilyaga, someone considered "in the know" and part of the subculture.
* **Dynamo-mashina (Динамо-машина)**: A taxi.
* **Globus (Глобус)**: A member of the mainstream, conforming society; someone considered "square" or "uncool."
* **Hata (Хата)**: An apartment.
* **Hatok (Хаток)**: Hat.
* **Jackequ (Джакец)**: Jacket.
* **Luke (Лукать)**: To look or watch.
* **Maneus (Манеус)**: Money.
* **Na Bolshoy (На большой)**: Excellent, great. Derived from the phrase "*na bolshoy palets*" (на большой палец) (thumbs up).
* **Old (Олд)**: Old.
* **Physer (Физер)**: Father.
* **Shoes (Шузы) (shuts)**: Stylish shoes, often with thick soles, either purchased from "*fartsovshchiks*" (black marketeers) or custom-made. Shoes with white soles were called "*manna kasha*" (манная каша) (semolina porridge).
* **Shtatniki (Штатники)**: Stilyagi who specifically sought to emulate authentic American fashion, as opposed to earlier, more exaggerated interpretations.
* **Sovparshiv (Совпаршив)**: A derogatory term for domestically produced consumer goods, literally "Soviet trash."
* **Soxs (Сокс)**: Socks, often in bright colors.
* **Style (Стилять)**: To dance in the Stilyagi style, imitating Western dance moves or inventing their own.
* **Tae (Тэ)**: Tie.
* **To pup (Пупать)**: To engage in sexual intercourse.
* **To throw a break (бросать брек)**: To go for a walk specifically to show off and be noticed, for example, "to throw a break on Broadway."
* **To wash (мыть), to flash (флэшевать)**: To walk or stroll, often with the intention of being seen.
* **Trenchcot (Тренчкот)**: Trench coat.
* **Trucker (Трузера) (trauser)**: Trousers.
...
- `images/stilyagi/Stilyagistyle.jpg`
- `images/stilyagi/Stilyagipropagandas.webp`
- `images/stilyagi/8bec903e-3992-4408-8f22-8e3e2c20c019.jpg`
- `images/stilyagi/Stilyagi.jpg`

## Source and attribution

Text adapted from "Stilyagi" on the Aesthetics Wiki (https://aesthetics.fandom.com/wiki/Stilyagi), licensed CC-BY-SA 4.0. Retrieved 2026-07-22. Images retain their individual licenses; see the local `credits.json`.
