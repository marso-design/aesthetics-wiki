...
Remember to check [what links here](https://aesthetics.fandom.com/wiki/Special:WhatLinksHere/Philosophy "Special:WhatLinksHere/Philosophy") and [the page history](https://aesthetics.fandom.com/wiki/Philosophy?action=history) before deletion.  
**Reason:** This page is a category error and an underdeveloped conceptual dump that attempts to define a broad sociological and philosophical topic. Its content is an uncurated essay that encourages the kind of subjective, unverifiable writing that violates the wiki's principles. Any useful information it contains is better explained on a case-by-case basis within the context of individual aesthetic pages, where a philosophy or set of values can be tied to a tangible visual style. The page's long-stalled development is a symptom of its flawed premise and its lack of unique value to the wiki.
...
One of the main features of aesthetics are the emotions invoked. These emotions cover an extremely wide spectrum. An an example, [Dark Academia](https://aesthetics.fandom.com/wiki/Dark_Academia "Dark Academia") can invoke emotions such as mystery and intrigue. On the other hand, [Weirdcore](https://aesthetics.fandom.com/wiki/Weirdcore "Weirdcore") can invoke feelings like surrealism. The emotions felt are one of the main factors that go into finding an aesthetic. Some people enjoy [Kawaii](https://aesthetics.fandom.com/wiki/Kawaii "Kawaii")'s soft and sweet feeling, but others may prefer [punk](https://aesthetics.fandom.com/wiki/Punk "Punk")'s sense of rebellion.

## Values

Values are another key characteristic of aesthetics. [Cottagecore](https://aesthetics.fandom.com/wiki/Cottagecore "Cottagecore") and [Goblincore](https://aesthetics.fandom.com/wiki/Goblincore "Goblincore") might seem similar on the outside, but Cottagecore values tradition and rejecting modern society, while Goblincore focuses on appreciating things which normally aren't considered beautiful. Many aesthetics that seem similar on the outside are completely different when their values are looked at. Similarly to emotions, these values cover a wide array, perhaps more.

## Experience

Certain aesthetics are mainly used as coping mechanisms for those who went through a shared experience. For instance, [Traumacore](https://aesthetics.fandom.com/wiki/Traumacore "Traumacore") is mainly used by those who have suffered trauma in the past, and use this aesthetic as a way to cope. In this way, experience can help shape the aesthetics you are attracted to.
...
## Social Issues (Society/Politics/Economics)
