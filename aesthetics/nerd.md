...
Remember to check [what links here](https://aesthetics.fandom.com/wiki/Special:WhatLinksHere/Nerd "Special:WhatLinksHere/Nerd") and [the page history](https://aesthetics.fandom.com/wiki/Nerd?action=history) before deletion.  
**Reason:** This page is a category error and a stereotype dump. It attempts to define a broad social label and personality type as an aesthetic, which is a fundamental misunderstanding of the wiki's purpose. The page's own content admits that "nerds don't have a specific style that is always followed," which is a clear sign that a distinct, reproducible aesthetic does not exist. The page is an uncurated dump of media, hobbies, and interests. It lists every major sci-fi and fantasy franchise as a visual motif, making the page too broad and unfocused to have a cohesive canon.
...
It is one of the four high school stereotypes popularly used to classify students, along with [Prep](https://aesthetics.fandom.com/wiki/Preppy "Preppy"), Jock, and [Goth](https://aesthetics.fandom.com/wiki/Goth "Goth").

## Visual

Nerd visual aesthetics will often take on references to popular fields and media indulged in by nerds, as well as the stereotypical depictions of nerds ranging from the 1950s all the way up to the 1990s before nerd subculture and media started becoming more mainstream, similar to other mainstream subcultures such the preppy, bro, and [emo](https://aesthetics.fandom.com/wiki/Emo "Emo") subcultures (in the past), and accepted by society in some way, shape, or form.
...
Starting in the 2000s, there has been a proud tradition of nerd culture-inspired music covering a vast array of genres, ranging from rock music to [rap music](https://aesthetics.fandom.com/wiki/Nerdcore "Nerdcore"). Outside of the nerd-specific genres, it has also found its way to seeing notes of it pop up in mainstream music, with many rappers dropping references to video games, comic books, and anime (a trend that can be traced back to the Wu-Tang Clan in the 1990s) as well as EDM artists making nods to the genre (ranging from Daft Punk's *Interstella 5555* anime done in collaboration with legendary anime producer Leiji Matsumoto to promote their *Discovery* album to Porter Robinson and Madeon's music video for the song "Shelter" done in collaboration with anime streaming service Crunchyroll and anime studio A-1 Pictures).
...
* Hacking technology
* Watching movies and TV shows (e.g. *Harry Potter*, *Star Trek*, *Star Wars*, *Doctor Who*)
...
* Reading about politics and political implications

## Visual

* Collections of library books
...
Napolean Dynamite and Pedro Sánchez from *Napolean Dynamite*
