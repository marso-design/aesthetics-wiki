...
name: "Net.art"
slug: "net-art"
aka: ["Internet Art", "Telematic Art"]
...
_Also known as: Internet Art, Telematic Art_
...
The widespread adoption of the World Wide Web in the mid-1990s marked a major turning point for the development of net.art. [Early websites](https://aesthetics.fandom.com/wiki/Webcore "Webcore"), characterized by static text and simple HTML, provided a new canvas for artistic experimentation. The term "**net.art**" gained prominence around this time. While the exact origin is debated, one account attributes it to a garbled email received by Slovenian artist Vuk Ćosić in 1995.
...
Similar to [Glitch Art](https://aesthetics.fandom.com/wiki/Glitch_Art "Glitch Art"), Net.art encompasses several creation techniques:
...
* **Hacking and Tactical Media:** Employing techniques associated with hacking to [subvert](https://aesthetics.fandom.com/wiki/Subvert "Subvert") online systems, critique corporate or institutional structures, or create interventions in digital spaces.
...
* [net-art.org](https://net-art.org/)
* [wwwwwwwww.jodi.org](https://wwwwwwwww.jodi.org/)
* [www.potatoland.org/shredder/](https://www.potatoland.org/shredder/)
* [mouchette.net](https://mouchette.net/)
* [www.ihatemouchette.org](https://www.ihatemouchette.org/)
* [www.stunned.org/playlets](https://www.stunned.org/playlets/)
* [net.art-generator.com/nags.html](https://net.art-generator.com/nags.html)

## Gallery

"wwwwwwwww.jodi.org" website (1995) by JODI (Joan Heemskerk and Dirk Paesmans)

"My Boyfriend Came Back From the War" (1996) by Olia Lialina

"The Shredder" (1998) by Mark Napier

"Last Words" (ongoing) by Darius Kazemi

"The Random Darknet Shopper" (2014-2015) by !Mediengruppe Bitnik

"Form Art" (1997) by Alexei Shulgin

"The File Room" (1994-ongoing) by Antonio Muntadas (interface/installation)

"La Plissure du Texte" (1983) by Roy Ascott (ARTEX interface)

"Poietic Generator" (1987/1997) by Olivier Auber (interface)

"Random Fear (with Mirrors)" by Rafael Rozendaal

"King's Cross Phone-In" (1994) by Heath Bunting (documentation image)

"Copies" (1998) by 0100101110101101.org (Eva Mattes and Franco Mattes)

"Rotating Google" (various years) by Constant Dullaart (screenshot/documentation)

"Deep ASCII" by Vuk Ćosić (1998)
...
- `images/net-art/1-ldgbpms7kehfwj-cmfw-xa.png`
- `images/net-art/Bb-ascii-art-screenshot-zebra.png`
- `images/net-art/Img-6-small480.jpg`

## Source and attribution

Text adapted from "Net.art" on the Aesthetics Wiki (https://aesthetics.fandom.com/wiki/Net.art), licensed CC-BY-SA 4.0. Retrieved 2026-07-22. Images retain their individual licenses; see the local `credits.json`.
