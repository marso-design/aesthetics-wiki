...
source_url: "https://aesthetics.fandom.com/wiki/Trxsh"
...
_Also known as: Trash Gang Aesthetic_

**Trxsh** (pronounced as "trash") is an internet aesthetic that originated in the late 2010s. It is based on the visual output of the Slovenia-based YouTube collective "Trash Gang." The style integrates elements of dark streetwear, underground emo rap, trap metal, and a specific technical style of Anime Music Video (AMV) editing. The subculture centered on the Trash Gang YouTube channel, founded in 2017. The aesthetic influenced the visual development of the early [E-Boy](https://aesthetics.fandom.com/wiki/E-Boy "E-Boy") and [E-Girl](https://aesthetics.fandom.com/wiki/E-Girl "E-Girl") styles, particularly through the use of high-contrast digital artifacts and re-edited anime iconography.
...
Fashion signifiers are a hybrid of [Skater](https://aesthetics.fandom.com/wiki/Skater "Skater"), [E-Boy](https://aesthetics.fandom.com/wiki/E-Boy "E-Boy"), and [Trap Metal](https://aesthetics.fandom.com/wiki/Trap_Metal "Trap Metal") attire. Primary components include black streetwear, oversized silhouettes, and heavy metal hardware such as layered chains. The style is often androgynous and incorporates the deconstructed garments associated with [Soft Grunge](https://aesthetics.fandom.com/wiki/Soft_Grunge "Soft Grunge").

## Music

### Genres

* [Emo Rap](https://aesthetics.fandom.com/wiki/Emo_Rap "Emo Rap"): A hybrid of mid-2000s emo themes and contemporary trap production.
* [Trap Metal](https://aesthetics.fandom.com/wiki/Trap_Metal "Trap Metal"): An aggressive subgenre utilizing distorted vocals and heavy guitar instrumentation over 808-heavy beats.
* [Cloud Rap](https://aesthetics.fandom.com/wiki/Cloud_Rap "Cloud Rap"): An atmospheric style characterized by slowed and reverb production and introspective lyrics.
...
* [ＴＲＡＳＨ 新 ドラゴン](https://www.youtube.com/@trash-gang) on YouTube
* [r/trashgang](https://www.reddit.com/r/trashgang/) on Reddit
* [Lyrical Lemonade](https://www.lyricallemonade.com/)

## Gallery

Ken Kaneki x XXXTentacion

ZeroTwo edit by @itachikvlt on Instagram
...
- `images/trxsh/Lxst.jpg`
- `images/trxsh/Trxsh1.jpg`
- `images/trxsh/Midoriya.jpg`
- `images/trxsh/Trashgang.jpg`
- `images/trxsh/TRASH-GANG.jpg`

## Source and attribution

Text adapted from "Trxsh" on the Aesthetics Wiki (https://aesthetics.fandom.com/wiki/Trxsh), licensed CC-BY-SA 4.0. Retrieved 2026-07-22. Images retain their individual licenses; see the local `credits.json`.
