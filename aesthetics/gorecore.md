...
_Also known as: Fleshcore, Slaughtercore, Murdercore_

Candidate for Deletion 🗑️

This page is a candidate for deletion.  
Remember to check [what links here](https://aesthetics.fandom.com/wiki/Special:WhatLinksHere/Gorecore "Special:WhatLinksHere/Gorecore") and [the page history](https://aesthetics.fandom.com/wiki/Gorecore?action=history) before deletion.  
**Reason:** Redundancy. Search results for this term predominantly return imagery that is already described by [Cutecore](https://aesthetics.fandom.com/wiki/Cutecore "Cutecore") or [Gurokawa](https://aesthetics.fandom.com/wiki/Gurokawa "Gurokawa"). This is a case of "-core" suffix abuse, where a descriptive keyword ("gore") is treated as a standalone movement without any unique history, music scene, or community separate from the aesthetics listed above. The history of this page has been plagued by content dumps of unrelated media (from Lady Gaga to Death Metal) because the term is too vague to be curated. The gallery demonstrates a complete lack of cohesive visual aesthetic. It indiscriminately mixes [Gurokawa](https://aesthetics.fandom.com/wiki/Gurokawa "Gurokawa") art (anime motifs), [Vampire](https://aesthetics.fandom.com/wiki/Vampire "Vampire") settings (cemeteries/churches), and standard [Goth](https://aesthetics.fandom.com/wiki/Goth "Goth")/[Mallgoth](https://aesthetics.fandom.com/wiki/Mallgoth "Mallgoth") fashion accessories.
...
**Reason for Warning:** This page discusses and displays graphic themes including depictions of blood, gore, violence, and murder. Reader discretion is advised.

**Gorecore** is an aesthetic primarily characterized by graphic visual content, focusing on elements such as blood, death, violence, and murder. It often features imagery drawn from [horror](https://aesthetics.fandom.com/wiki/Horror "Horror") fiction, including slasher films, and can encompass highly disturbing or unsettling visuals, though often stylized. This aesthetic is a compound term, incorporating anything disturbing, terrifying, or horrible, often with explicit depictions of blood. Its visual and stylistic expressions are also seen as a way to challenge conventional beauty standards and, for some, to subvert the male gaze. It sometimes overlaps with [Pastel Gore](https://aesthetics.fandom.com/wiki/Pastel_Gore "Pastel Gore") and [Cutegore](https://aesthetics.fandom.com/wiki/Cutegore "Cutegore").
...
A choker from Angry Young And Poor that has spikes and hanging razor blades.

A blood choker from SHEIN.

A earring set from Hot Topic that includes knifes, hearts, and some blood drops.

A gore sweater from H0neybear.

Skeleton sweater from Romwe.
...
- `images/gorecore/Girlgorecore.jpg`
- `images/gorecore/Goresweater.jpg`
- `images/gorecore/Ribsweater.jpg`
- `images/gorecore/King-sword-blood.jpg`
- `images/gorecore/Bloody-knuckles.jpg`
- `images/gorecore/9b4d7ab60e264f61a9c3ae3e69e651e7.jpg`
- `images/gorecore/Bloodred.jpeg`
- `images/gorecore/Theperfectredvelvet.jpg`
- `images/gorecore/Gothcore-lipstick-chains.jpg`
- `images/gorecore/Gothc-red-cross.jpg`
- `images/gorecore/Gothc-milli.webp`
- `images/gorecore/Gothc-red-trees.jpg`
- `images/gorecore/Redfleshblur.png`
- `images/gorecore/Gorecore-dr-mystery.webp`
- `images/gorecore/GORECOR3!!!.gif`

## Source and attribution

Text adapted from "Gorecore" on the Aesthetics Wiki (https://aesthetics.fandom.com/wiki/Gorecore), licensed CC-BY-SA 4.0. Retrieved 2026-07-22. Images retain their individual licenses; see the local `credits.json`.
