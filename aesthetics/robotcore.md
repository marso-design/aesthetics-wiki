...
name: "Robotcore"
slug: "robotcore"
aka: ["Codingcore", "AI.core", "Androidcore"]
...
_Also known as: Codingcore, AI.core, Androidcore_
...
**Reason for Warning:** This page contains some themes surrounding extinction and depersonalization.
...
**Robotcore** is the aesthetic name for a community filled to the brim with the aforementioned new generations of people, most of whom don't have the skills or degree to work on professional robots but still want to be involved in the robotics world in some shape or form. People who identify with the **Robotcore** aesthetic often relate to robots, doing activities such as listening to electronic music or going even as far as to act and/or present as one. Like [Fairycore](https://aesthetics.fandom.com/wiki/Fairycore "Fairycore"), the aesthetic is popular with botkin.
...
* Circuit boards and/or robot parts
* Code and coding software
* Robots, AI, and androids
* Robotic and/or futuristic technology such as weapons, buildings, and/or landscapes
* Very bright neon lights and signs
* Other futuristic elements commonly portrayed in media

## Media

### Film

* *Matrix franchise (1999-2021)*
* *Archive* (2020)
* *Astro Boy* (2009)
* *I, Robot* (2004)
* *Robots* (2005)
...
* *WALL-E* (Wii) - Heavy Iron Studios/Walt Disney Interactive
* *JumpStart 3rd Grade: Mystery Mountain* - Knowledge Adventure
* *JumpStart Typing* - Knowledge Adventure
* Geth in *Mass Effect* - Bioware/EA
* *Stellaris: Synthetic Dawn* DLC - Paradox Interactive
* *Astro Bot* - Team Asobi/Sony Interactive Entertainment
* *Mega Man* franchise - Capcom
* *Portal* franchise - Valve
...
* Runaway D - deathgrips [[1]](https://soundcloud.com/deathgrips/runway-d)
* Geocities - Lemon Demon
* Leni - Crystal Castles
* Operating Ease - solvent
* 03-rapid\_data\_transfer - Oliver Buckland
* Lucky Lady - Ryo Kawasaki
* Credits - Frums
...
* Coding
* Cosplaying as robot and/or android characters
* Making and/or tinkering with robots and their parts
* Designing Robotsonas
* Acting like a robot

## Gallery

A robot holding their palm out in front of a bubble

A moodboard based on the aesthetic.

Another moodboard based on the aesthetic.

A Robotcore cosplayer.
