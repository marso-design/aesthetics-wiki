...
aka: ["Scientific Academia", "STEM Academia"]
...
_Also known as: Scientific Academia, STEM Academia_

Candidate for Deletion 🗑️

This page is a candidate for deletion.  
Remember to check [what links here](https://aesthetics.fandom.com/wiki/Special:WhatLinksHere/Science_Academia "Special:WhatLinksHere/Science Academia") and [the page history](https://aesthetics.fandom.com/wiki/Science_Academia?action=history) before deletion.  
**Reason:** This page lacks independent notability, being primarily a thematic application of [Dark Academia](https://aesthetics.fandom.com/wiki/Dark_Academia "Dark Academia") to STEM fields. The visuals and philosophy are largely borrowed from Dark Academia, with scientific paraphernalia added, which doesn't constitute a sufficiently distinct aesthetic. It also borders on describing a subject or field of study rather than a widely adopted aesthetic with a unique visual language and cultural presence.

**Science Academia**, also known as **STEM Academia**, is an [Academic](https://aesthetics.fandom.com/wiki/Category:Academia "Category:Academia") aesthetic specializing in the formal, natural, and, to a lesser extent, social sciences. It differs from most other academic aesthetics, which center on the arts and humanities.
...
Science academia is often described as [Dark Academia](https://aesthetics.fandom.com/wiki/Dark_Academia "Dark Academia") applied to the sciences.
...
* SCP Foundation
* [Korea Tourism Organization's Naju Pear Museum promo](https://youtu.be/adj_3ZAIBcE?si=G1HvLMuKzqaCS0fe)
