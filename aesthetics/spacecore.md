...
_Also known as: Astrocore_

**Spacecore** is a contemporary internet aesthetic centered around the romanticization and artistic stylization of the cosmos. The aesthetic uses abstract, highly saturated imagery of stars, planets, and galaxies as a motif for fashion, digital art, and home décor. The style is explicitly escapist and fantastical, distinguishing itself from hard science, military sci-fi, and historical [space age](https://aesthetics.fandom.com/wiki/Space_Age "Space Age") aesthetics.
...
Spacecore fashion incorporates the decorative cosmic imagery into wearable items, often favoring styles that utilize dramatic prints, glitter, and reflective materials, occasionally blending with Harajuku styles like [Uchuu Kei](https://aesthetics.fandom.com/wiki/Uchuu_Kei "Uchuu Kei").
...
* K-Pop Songs by WJSN ("As You Wish," "Secret"), LOONA ("Star","Satellite"), Kep1er ("Shooting Star"), TWICE ("MARS"), Taeyeon ("INVU").
...
* Alien Stage (2022-2025)

## Gallery

A subgenre puts retro elements into a dreamlike, escapist setting with surreal spacescapes, exaggerating and romanticizing or parodying the promises of [Space Age](https://aesthetics.fandom.com/wiki/Space_Age "Space Age")

Note the road winding into space

## Videos

TYPES OF AESTHETIC -- Part.4

Examples of Spacecore are given around the 2:13 mark.
