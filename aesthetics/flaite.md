...
name: "Flaite"
slug: "flaite"
aka: ["Pinganilla", "Roto", "Chipamogli (slang)"]
decade_of_origin: "1990s"
key_motifs: ["Sportswear (Nike, Adidas)", "\"Sopaipilla\" haircut", "oversized or skinny jeans (era dependent)", "bling-bling", "soccer jerseys"]
key_colours: ["White", "black", "neon accents", "denim blue"]
key_values: ["Choreza (toughness)", "consumerism", "loyalty", "rebellion against hierarchy"]
related_aesthetics: ["Cani", "Cumbiero", "Gangsta Rap", "Pokemón", "Reggaetonero", "Turro"]
primary_platform: ["Street culture", "Fotolog (historically)", "Facebook", "TikTok"]
related_media: ["Dash & Cangri", "Perla", "El Reemplazante"]
...
_Also known as: Pinganilla, Roto, Chipamogli (slang)_
...
* **The "Flight" Theory:** This is the most common theory. It suggests the term comes from the Nike Air Flight sneakers, which were highly coveted by youth in marginalized neighborhoods in the 1990s. The term "Flaite" may have originally described people who wore these shoes (or counterfeit versions of them).
* **The "Fly" Theory:** This theory suggests it derives from the verb "to fly" or "flyer," linked to the Chilean slang term *volado* (stoned/high), originally associating the subculture with drug use.
* **The "Faite" Theory:** A linguistic theory suggesting it comes from the Peruvian slang *faite*, which itself comes from the English "fighter," used to describe a tough criminal.

### Origins

The Flaite phenomenon emerged in the post-dictatorship era of Chile (1990s onwards), a period marked by the aggressive expansion of neoliberal economics. As American pop culture flooded the country, marginalized youth began to adopt the aesthetics of global [hip-hop](https://aesthetics.fandom.com/wiki/Hip-hop "Hip-hop") and [gangsta rap](https://aesthetics.fandom.com/wiki/Gangsta_Rap "Gangsta Rap") to construct an identity.
...
* Extremely baggy jeans, often featuring embroidery of cartoon characters (specifically the Tasmanian Devil or Looney Tunes), a trend linked to the movie *Space Jam*.
* Large basketball tank tops (Lakers, Bulls) or American football jerseys.
* High-top sneakers, specifically chunky basketball shoes like Nike Air Jordans or And1s.

### Late 2000s–Present (Reggaeton & Wachiturro Era)
...
* Skinny jeans, often acid-washed ("*nevados*"), distressed, or brightly colored.
* Performance sportswear like soccer jerseys (particularly of the team Colo-Colo) and tracksuits.
* Polo shirts, particularly by Lacoste, worn with the collar popped up.
* Thick silver or gold chains ("bling-bling"), oversized sunglasses (Oakley), and jockey caps worn resting high on the crown of the head rather than pulled down.
...
* **[Cumbia Villera](https://aesthetics.fandom.com/wiki/Cumbiero "Cumbiero"):** A style of cumbia originating in Argentine slums, dealing with themes of poverty and crime (e.g., Damas Gratis).
* **[Reggaeton](https://aesthetics.fandom.com/wiki/Reggaeton "Reggaeton"):** The dominant genre for arguably two decades, providing the fashion and behavioral templates.
* **Trap and Urban:** Modern Chilean Trap artists often embrace the "flaite" aesthetic as a badge of honor rather than an insult.

## Media

### Television

* *Dash & Cangri* (2012) - (Docu-reality series following young men from the subculture)
* *Perla, tan real como tú* (2011-2012) - (Reality show)
* *El Reemplazante* (2012) - (TV series depicting life in marginalized schools)

### Fictional Characters

* El Shá! (Comedic character by Daniel Muñoz parodiing the archetype)
