...
Older websites, imageboards, and forums associated with the [emo](https://aesthetics.fandom.com/wiki/Emo "Emo")/[scene](https://aesthetics.fandom.com/wiki/Scene "Scene") subculture from the 2000s document the popularity of kandi beyond rave settings. While these subcultures did not originate kandi, they contributed to its wider dissemination.
...
* [r/kandi](https://www.reddit.com/r/kandi/) on Reddit
* [Kandi Tutorials](https://www.youtube.com/results?search_query=kandi+tutorial) on YouTube

## Gallery

Picture by RAV3 G1RL on Pinterest.

A raver wearing kandi bracelets. Picture by @sunflowerraver.

Kandi Bracelets

Neon Kandi Bracelets

Glow in the dark kandi bikini. Picture by CarolineChaos.
