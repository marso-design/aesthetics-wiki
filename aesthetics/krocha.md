...
source_url: "https://aesthetics.fandom.com/wiki/Krocha"
...
_Also known as: Kracher, Netlog Styler_
...
The dance style associated with Krocha is highly energetic. It involves a lot of jumping, kicking, and other fast movements, described as "wild" and even somewhat "epileptic" by the ATV. It was influenced by [Jumpstyle](https://aesthetics.fandom.com/wiki/Jumpstyle "Jumpstyle"), Hardstyle, and also incorporated some elements of Charleston. At the height of the trend, some dance schools in Austria even offered classes specifically on Krocha dancing. This dance style also shared some similarities with French [Tecktonik](https://aesthetics.fandom.com/wiki/Tecktonik "Tecktonik"), which involved less leg movements in contrast, basically the yin to Krocha's yang.
...
* *Oida* (meaning "dude" or "old man")
* *Fix* (meaning "for sure")
* *Bam* (meaning "wow")
* *Bam Oida* (meaning "Wow, dude")
* *Fix Oida* (meaning "For sure, dude")
* *So Fesch* (roughly translating to "So Chic")
* *Kroch' ma' eine* (meaning "let's crash in/have fun," referring to entering a discotheque)
* *Eini krochn* (meaning "Let's go in")
* *Pock i ned* (meaning "I can't do/believe it")
* *Süße* becomes "SüZze"
* *Schnucki* becomes "SchnuQQi"
* *Bussi* becomes "Buccä"
* *Schatz* becomes "SaCc"
* *Lieb* becomes "lüPp"
...
Philipp Ikrath, head of the Hamburg department of the Institute for Youth Culture Research in Vienna, characterized Krocha as a "pure fun culture" in *Der Standard* (2008), criticizing them for their focus on self-expression and consumerism. He also criticized the [appropriation](https://aesthetics.fandom.com/wiki/Appropriation "Appropriation") of symbols like the Palestinian scarf (*keffiyeh*, also known as *Palästinensertuch* in German), which held no political or cultural significance for the Krocha and was merely seen as a simple fashion accessory. Ikrath predicted that the trend would be short-lived, arguing that Vienna was not typically a city where international trends originated.

## Music

### Genres

* **Schranz** - A subgenre of techno characterized by its fast tempo (typically between 150 and 170 BPM), distorted and harsh sounds, and heavy use of repetitive loops. It originated in Germany and typically has a dark and industrial atmosphere.
* **Hardstyle** - A high-energy electronic dance music genre with a fast tempo (150 BPM), heavy kicks, and intense bass. It often features distorted kicks.
* **[Jumpstyle](https://aesthetics.fandom.com/wiki/Jumpstyle "Jumpstyle")** - A dance and electronic music genre characterized by its fast tempo (around 140-160 BPM). The dance involves jumping and kicking with synchronized leg movements, usually performed in groups.
* **Techno** - A genre of electronic dance music characterized by a repetitive four-on-the-floor beat, and a tempo typically between 120 and 150 BPM.
* **[Hands Up](https://aesthetics.fandom.com/wiki/Hands_Up "Hands Up")** - A combination of Eurodance, Trance, and Techno, characterized by catchy melodies and singalong choruses. Was popular in European nightclubs during the 2000s.

### Songs

* Angel Scream (Mr. P!Nk Club Mix) by Mr. Pink & Dorian
* Alle Meine Krocha by Krocha Dee Jay
* Bam Oida Fix Oida by DJ Freaky
* Colours of the Hardstyle by Showtek
* Da Beat Goes... by Red 5
* Hava Tequila by Jump Project
* I'm a Raver by UK Maniax
* Krocha Hymne by Die Vamummtn
* Nostra Culpa (DJ E-MaxX Radio Edit) by DJ MNS Vs. E-MAXX
* Let Me Think About It by DJ Fedde
* Omen 3 (Nightshifterz Remix) by Magic Affair
* Raver by Showtek
* Springstil (Ey Heb Die Beine An) by Springstil
* Ultimate Krocha Anthem by Stee Wee Bee
* 1980 (Marshal Mix) by Citizen

## Gallery

Photo taken at a Scooter concert.

Photo by Andreas Tischler, taken at the Lugner City mall.
...
Krocha Beitrag von ATV

Austrian news segment from the ATV, reporting the popularization of Krocha

Best krocha

Krocha Contest Wien 2-7

Krocha Contest Wien 6-7

Krocha Contest Wien 7-7

Cover art for "Vamummtn Krocha Hymne" by Die Vamummtn

Cover art for "Szene 1 Krocha Traxx"

Cover art for "Krocha Hits-Bam Oida 2"

Cover art for "Krocha Traxx Vol. 1"
...
- `images/krocha/Krocha.jpeg`
- `images/krocha/Krocha3.png`
- `images/krocha/Krocha4.jpeg`
- `images/krocha/Krocha6.png`
- `images/krocha/Krocha5.jpeg`
- `images/krocha/KrochaLugnerCity.jpg`
- `images/krocha/KrochaAndreasTischler.jpg`
- `images/krocha/AndreasTischlerKrocha.jpg`
- `images/krocha/Krocha-girls.png`
- `images/krocha/KrochaHymne.jpg`
- `images/krocha/Krochatraxx.jpg`
- `images/krocha/KrochaStyle.jpg`

## Source and attribution

Text adapted from "Krocha" on the Aesthetics Wiki (https://aesthetics.fandom.com/wiki/Krocha), licensed CC-BY-SA 4.0. Retrieved 2026-07-22. Images retain their individual licenses; see the local `credits.json`.
