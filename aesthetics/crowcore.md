...
_Also known as: Corvidcore_

Needs Work 🛠️

This page requires improvement. Please help us by [expanding it](https://aesthetics.fandom.com/wiki/Crowcore?action=edit). If you are unsure how to help, check the article guide [Format and Content](https://aesthetics.fandom.com/wiki/Format_and_Content "Format and Content").

**Crowcore** is primarily derived from [Goblincore](https://aesthetics.fandom.com/wiki/Goblincore "Goblincore") and [Cottagecore](https://aesthetics.fandom.com/wiki/Cottagecore "Cottagecore"). This aesthetic focuses mainly on [nature](https://aesthetics.fandom.com/wiki/Naturecore "Naturecore"), environmentalism, crows and collecting (usually shiny) objects from nature and urban environments. Crowcore is generally darker than either of its initial inspirations.
...
There is significant Tumblr cross-tagging between Crowcore, Gremlincore, Cottagecore, [Cottagegore](https://aesthetics.fandom.com/wiki/Cottagegore "Cottagegore"), and various other related aesthetics.
...
* Bones/Animal skulls(see [Vulture Culture](https://aesthetics.fandom.com/wiki/Vulture_Culture "Vulture Culture"))
* Rusty bottle caps
* Tiny sculptures (usually of birds or other forest friends)
* [Vintage](https://aesthetics.fandom.com/wiki/Vintage "Vintage") brooches/lockets
* Seaglass
...
* [Exploring](https://aesthetics.fandom.com/wiki/Adventurecore "Adventurecore")
...
Crowcore fashion is similar to [Cottagegore](https://aesthetics.fandom.com/wiki/Cottagegore "Cottagegore") and Goblincore. It is darker than Cottagecore but with light, mysterious, and playful aspects.

## Gallery

Idk, felt like this fit

Feel like it slightly fits?

Tell me this person doesn’t collect shiny things
