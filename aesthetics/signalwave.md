...
name: "Signalwave"
slug: "signalwave"
aka: ["Broken Transmission"]
decade_of_origin: "Early 2010s"
key_motifs: ["Old TV/radio broadcasts", "commercials", "jingles", "weather channels", "station sign-offs", "static", "VHS distortion", "channel surfing"]
...
Signalwave emerged in the early 2010s from the more experimental side of the [Vaporwave](https://aesthetics.fandom.com/wiki/Vaporwave "Vaporwave") scene, alongside the development of the broader genre. Early pioneers began to focus less on sampling smooth jazz or pop music and more on the ambient and incidental sounds of broadcast media. Foundational releases from artists like *Midnight Television* (2011) and *Infinity Frequencies* (2012) established the genre's focus on looping, lo-fi samples to create a detached, eerie atmosphere.
...
* "Prism Genesis" by Fuji Grid TV
* "Computer Death" by Infinity Frequencies
* "Dream Sequins®" by Nmesh
* "News at 11" by 猫 シ Corp.
* "▣世界から解放され▣" (Freed from the world) by ░▒▓新しいデラックスライフ▓▒░ (INTERNET CLUB)
* "ひまわり画像" (Sunflower Image) by 天気予報 (Weather Forecast)
* ”Nowhere at the Millennium of Space: Redux” by The Caretakers
...
| Conceptual |
| [Political 'Wave' Aesthetics](https://aesthetics.fandom.com/wiki/Political_%27Wave%27_Aesthetics "Political 'Wave' Aesthetics") ✪ **Signalwave** ✪ [Spainwave](https://aesthetics.fandom.com/wiki/Spainwave "Spainwave") |
