...
name: "Bakala"
slug: "bakala"
aka: ["Makinero", "Bakalaero", "Ruta Destroy", "Rutero", "Pastillero"]
...
_Also known as: Makinero, Bakalaero, Ruta Destroy, Rutero, Pastillero_
...
**Reason for Warning:** This page documents a countercultural movement characterized by severe substance abuse. The history section discusses the prevalence of ecstasy use and the association of the movement's decline with fatal road accidents and police crackdowns. Viewer discretion is advised.

**Bakala** (often used interchangeably with **Makinero**) is a Spanish youth subculture that emerged in the late 1980s and flourished throughout the 1990s. They were the primary demographic of the **[Ruta del Bakalao](https://en.wikipedia.org/wiki/Ruta_del_Bakalao "wikipedia:Ruta del Bakalao")** (also known as *Ruta Destroy*), a massive nightlife phenomenon centered in Valencia that involved partying in macro-discotheques for 72 hours continuously.

The aesthetic is characterized by a "hard" appearance influenced by [Gabber](https://aesthetics.fandom.com/wiki/Gabber "Gabber") and [Skinhead](https://aesthetics.fandom.com/wiki/Skinhead "Skinhead") fashion, a devotion to high-BPM electronic music (Mákina and Hardcore), and a specific grooming style known as the "*Cenicero*" (Ashtray) cut.

While originally a cutting-edge avant-garde movement in the 80s, the subculture was later stigmatized by mass media due to its association with drug use (ecstasy/speed), fatal road accidents, and eventual assimilation into the "[Cani](https://aesthetics.fandom.com/wiki/Cani "Cani")" stereotype.
...
* **Bakalaero:** The original clubber of the 1980s. Sophisticated and avant-garde, they listened to [EBM](https://aesthetics.fandom.com/wiki/EBM "EBM"), [New Beat](https://aesthetics.fandom.com/wiki/New_Beat "New Beat"), and Synth-pop. This term became obsolete by the early 90s.
...
* **Hardcoriano:** A harder subset that preferred [Gabber](https://aesthetics.fandom.com/wiki/Gabber "Gabber"), Terrorcore, and Speedcore. They maintained the most aggressive, militaristic aesthetic (shaved heads, bomber jackets) for the longest time.

### The Golden Age: La Ruta Destroy

> "*Without [EBM](https://aesthetics.fandom.com/wiki/EBM "EBM") and North European synth-pop and Spanish clubs and DJs of the mid-80s, there would be no Techno.*"
> ― DJ The Hacker
...
In the early 1980s, clubs along the CV-500 road began importing [post-punk](https://aesthetics.fandom.com/wiki/Post-punk "Post-punk") and [industrial](https://aesthetics.fandom.com/wiki/Industrial "Industrial") music, attracting an eclectic crowd initially known as "Bakalaeros." These early adopters were characterized by a sophisticated appreciation for [EBM](https://aesthetics.fandom.com/wiki/EBM "EBM"), Belgian [New Beat](https://aesthetics.fandom.com/wiki/New_Beat "New Beat"), and Synth-pop (e.g., they listened to bands like Kraftwerk and Front 242), distinct from the harder "Makineros" that would define the 1990s.

By the early 1990s, the movement solidified into the "Ruta Destroy." A distinct clubbing circuit formed around venues like Spook Factory, Puzzle, and Barraca, where thousands of youths participated in a ritual of continuous partying from Friday to Monday morning. As the sound shifted toward harder, faster electronic genres, the demographic evolved into the "Makinero" or "Bakala" identity. This period, often termed the Golden Age, saw the subculture become a mass phenomenon, with youths driving from Madrid and Catalonia to participate in the communal, hedonistic atmosphere that prefigured modern [rave](https://aesthetics.fandom.com/wiki/Rave "Rave") culture.
...
Simultaneously, the subculture became politically polarized. While the early scene was largely apolitical, the later "Hardcore" phase saw a division between "*Españolistas*" (Spanish nativists), who were often associated with right-wing nationalism and urban centers, and "*Catalanistas*" (Catalan independentists), who leaned toward anti-fascist or independence movements in rural areas. This tension, combined with the commercialization of the music into generic "*Cantaditas*," led to the closure of many iconic clubs by 1995 and the assimilation of the remaining aesthetic into [Pokeros](https://aesthetics.fandom.com/wiki/Pokero "Pokero") and the most infamously, the broader [Cani](https://aesthetics.fandom.com/wiki/Cani "Cani") subculture.
...
The Bakala aesthetic was a functional uniform designed for endurance dancing, evolving from earlier [New Romantic](https://aesthetics.fandom.com/wiki/New_Romantic "New Romantic") influences into a harder, militaristic look. The style prioritized a tight, "bad boy" silhouette that displayed physical fitness and group loyalty through specific brands.
...
Designers such as Edu Marín, Paco Bascuñán, and Quique Company established a visual language that drew heavily from [industrial](https://aesthetics.fandom.com/wiki/Industrial "Industrial") textures, experimental underground comics, and modernist principles like [Bauhaus](https://aesthetics.fandom.com/wiki/Bauhaus "Bauhaus") typography. These visuals were often high-contrast and utilized bold, striking imagery to capture the mechanical energy of the nightlife, a legacy recently celebrated in the 2022 "Ruta Gráfica" exhibition at the IVAM museum.
...
Puzzle, from the summer of 1989
...
The musical evolution of the scene mirrored the shift from the "*Moderno*" to the "Makinero." The early phase was defined by guitar-based [Post-Punk](https://aesthetics.fandom.com/wiki/Post-Punk "Post-Punk") and [EBM](https://aesthetics.fandom.com/wiki/EBM "EBM") imported from countries like Great Britain, Germany, and Belgium, featuring acts like Front 242 and The Sisters of Mercy. By the early 1990s, this coalesced into the "*Sonido de Valencia*," a fusion of industrial techno and [New Beat](https://aesthetics.fandom.com/wiki/New_Beat "New Beat").
...
The "Ruta Destroy" was originally defined by an eclectic mix of guitar music and dark industrial sounds. This era is characterized by the consumption of [EBM](https://aesthetics.fandom.com/wiki/EBM "EBM"), [New Beat](https://aesthetics.fandom.com/wiki/New_Beat "New Beat"), and [Post-Punk](https://aesthetics.fandom.com/wiki/Post-Punk "Post-Punk").
...
As the 90s began, the sound shifted toward a unique local fusion of Techno and [New Beat](https://aesthetics.fandom.com/wiki/New_Beat "New Beat"), bridging the gap between dark EBM and the upcoming explosion of speed.
...
* **Chocolate:** Located just 200m from Barraca. Known for darker [industrial](https://aesthetics.fandom.com/wiki/Industrial "Industrial") sounds and serving "Paella" at dawn.
...
* [RYM Ultimate Box Set > Mákina](https://rateyourmusic.com/list/TheScientist/rym-ultimate-box-set-makina/)
* [Mákina](https://rateyourmusic.com/genre/makina/) on Rate Your Music
* [Mákina](https://everynoise.com/engenremap-makina.html) on Every Noise at Once
* [Ruta Destroy](https://everynoise.com/engenremap-rutadestroy.html) on Every Noise at Once

### Websites

* [rutadestroy.com](https://rutadestroy.com/)
* [makineros.com](https://makineros.com/)
* [larutadelbacalao.com](https://larutadelbacalao.com/)
* [generacionmakina.com](https://generacionmakina.com/)
* [makinamania.net](https://www.makinamania.net/) - A forum about Mákina music.
* [MDT Radio](https://mdtradio.com/) - A radio based in Valencia that focuses on 80s-90s Techno music.
* [Spektra FM](https://spektrafm.es/) - Same as above.
* [scorpia.net](https://www.scorpia.net/) - The official website of Scorpia Central del Sonido.
* [discotecachocolate.com](https://discotecachocolate.com/) The official website of the Chocolate nightclub.

## Gallery

DJ Chimo Bayo.

Maria Ke Fisherman collection inspired by Ruta Destroy fashion.

Teenagers at the parking lot of The Face (formerly Dream's Village)

Chimo Bayo performing at El Templo (early 1990s)

The Stone Roses at Barraca nightclub, Valencia (1989)

Cast of "The Route," a 2022 television series depicting the Ruta Destroy era.

Cast of "The Route" television series.

*Ruta Gráfica* exhibition at the IVAM museum, Valencia (2022)

Logos from various Valencian nightclubs.

Spook flyer from Christmas Eve, 1988.

ACTV flyer.

## Videos

Ramirez - Bomba (Official Video)

Chimo Bayo - Asi me gusta a mí

No cambies - Asap

Video Ruta Destroy Por la ruta del bakalao
...
| --- | --- | --- |
| Core Aesthetics |
| [Rave](https://aesthetics.fandom.com/wiki/Rave "Rave") ☺ [Acid House](https://aesthetics.fandom.com/wiki/Acid_House "Acid House") ☺ [Gabber](https://aesthetics.fandom.com/wiki/Gabber "Gabber") ☺ [Kandi Raver](https://aesthetics.fandom.com/wiki/Kandi_Raver "Kandi Raver") ☺ [Berlin Techno Fashion](https://aesthetics.fandom.com/wiki/Berlin_Techno_Fashion "Berlin Techno Fashion") ☺ **Bakala** ☺ [Krocha](https://aesthetics.fandom.com/wiki/Krocha "Krocha") ☺ [Madchester](https://aesthetics.fandom.com/wiki/Madchester "Madchester") ☺ [New Beat](https://aesthetics.fandom.com/wiki/New_Beat "New Beat") ☺ [Pokero](https://aesthetics.fandom.com/wiki/Pokero "Pokero") ☺ [Tecktonik](https://aesthetics.fandom.com/wiki/Tecktonik "Tecktonik") ☺ [UK Garage](https://aesthetics.fandom.com/wiki/UK_Garage "UK Garage") ☺ [Wixa](https://aesthetics.fandom.com/wiki/Wixa "Wixa") |
| Fusion Aesthetics |
