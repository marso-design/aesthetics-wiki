...
name: "Grandmacore"
slug: "grandmacore"
key_motifs: ["kindness", "baking", "knitting/crocheting", "embroidery/sewing"]
...
This page requires improvement. Please help us by [expanding it](https://aesthetics.fandom.com/wiki/Grandmacore?action=edit). If you are unsure how to help, check the article guide [Format and Content](https://aesthetics.fandom.com/wiki/Format_and_Content "Format and Content").

**Grandmacore** refers to an aesthetic that is based around cottage and stereotypical grandma-related things such as gardening, soft knitted fabric, crocheting, farmland animals, fresh baked bread, and other visuals.
...
- `images/grandmacore/Grandmashouse.jpg`
- `images/grandmacore/Ceramics.jpg`
- `images/grandmacore/Missmarple.jpg`

## Source and attribution

Text adapted from "Grandmacore" on the Aesthetics Wiki (https://aesthetics.fandom.com/wiki/Grandmacore), licensed CC-BY-SA 4.0. Retrieved 2026-07-22. Images retain their individual licenses; see the local `credits.json`.
