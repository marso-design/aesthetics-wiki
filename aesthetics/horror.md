...
This page requires improvement. Please help us by [expanding it](https://aesthetics.fandom.com/wiki/Horror?action=edit). If you are unsure how to help, check the article guide [Format and Content](https://aesthetics.fandom.com/wiki/Format_and_Content "Format and Content").  
**Reason:** This page is currently a conceptual dump that incorrectly treats "Horror" as a single aesthetic. It is actually a broad genre of fiction. The page contains numerous subgenres, from music (Horrorcore) to films (Slasher) and historical phenomena (Satanic Panic), all of which have their own distinct and verifiable aesthetics. The page should be restructured as a non-aesthetic overview page that defines the genre and links to all the specific, curatable sub-aesthetics that fall under its umbrella. All subgenre content must be extracted and used to create new, dedicated pages.
...
**Reason for Warning:** This aesthetic has potential to touch on dark subject matter, including real-world murder and acts of violence.
...
The popular examples and the clear starter and codifier of this in action on a video game form are the [*Five Nights at Freddy's*](https://freddy-fazbears-pizza.fandom.com/wiki/Five_Nights_at_Freddy%27s_Wiki) and [*Bendy*](https://bendy.fandom.com/wiki/Bendy_Wiki) franchises. and lesser-known examples like *Choo-Choo Charles*, *Indigo Park*, *Finding Frankie*, *Giggleland*, and [*My Friendly Neighborhood*](https://my-friendly-neighborhood.fandom.com/wiki/My_Friendly_Neighborhood). Non-video game examples include *Willy's Wonderland* (film), *Hug* (short film), *Westworld* (live-action series), anime/manga *Gleipnir,* and certain episodes of animated and live-action shows like *Adventure Time*'s "Dark Purple".
...
#### "Family-Friendly" Mascot Horror

**"Family-Friendly Mascot Horror"** or less commonly **"Kid-Friendly Mascot Horror"** (not to be confused with **Kid Horror**, where corrupted and evil mascots are not the main focus) is a pejorative term that refers to the infamous state of mascot horror in video games, which sprung up after the releases of *Poppy Playtime*, *Five Nights at Freddy's: Security Breach*, and *Garten of BanBan* in 2021 and 2023. These games in turn were often labelled as family-friendly mascot horror by the masses out of frustration with the state of horror at the time, believing that these games did not take themselves seriously, by prioritizing the mascot-focused elements of the subgenre. "Family-friendly" and/or "kid-friendly" mascot horror games are believed to misuse the aesthetics and themes found in mascot horror. The term has also been applied to games believed to be ripoffs of games like *Poppy Playtime* (more specifically, the first two chapters) and *Garten of BanBan*, using freely-accessible game engines like Roblox's or Unity's.
...
**Comedy Horror** entwines horror and comedy to create a situation where viewers are able to laugh at their fears while also experiencing terror, with examples like [The Evil Dead: Army of Darkness](https://evildead.fandom.com/wiki/Army_of_Darkness), [Beetlejuice](https://beetlejuice.fandom.com/wiki/Beetlejuice_Wiki), etc.

### Medical Horror

**[Medical](https://aesthetics.fandom.com/wiki/Medicalcore "Medicalcore") Horror** is a subgenre that often overlaps with psychological horror and body horror, and uses the anxieties and vulnerabilities associated with medicine, illness, and the human body to create a sense of fear and unease. It often features themes of medical experimentation gone wrong, [lobotomies](https://aesthetics.fandom.com/wiki/Lobotomy_Chic "Lobotomy Chic"), evil doctors, gruesome diseases, body horror/[gore](https://aesthetics.fandom.com/wiki/Gorecore "Gorecore"), and the dark side of medical technology. Examples include *Re-Animator*, *REPO! The Genetic Opera* and *The Human Centipede*.
...
* [*Dead by Daylight*](https://deadbydaylight.fandom.com/wiki/Dead_by_Daylight_Wiki)
* [*Silent Hill*](https://silenthill.fandom.com/wiki/Silent_Hill_Wiki) Series
* [*Amnesia*](https://amnesia.fandom.com/wiki/Amnesia_Wiki) Series
* [*Outlast*](https://outlast.fandom.com/wiki/Outlast_Wiki) Series
* [*Resident Evil*](https://residentevil.fandom.com/wiki/Resident_Evil_Wiki) Series
* [*Until Dawn*](https://until-dawn.fandom.com/wiki/Until_Dawn_Wiki)
* [*The Evil Within*](https://theevilwithin.fandom.com/wiki/The_Evil_Within_Wiki) Duology
* [*Observer*](https://observer.fandom.com/wiki/Observer_Wiki)
* [*Slenderman: The Eight Pages*](https://theslenderman.fandom.com/wiki/Slender)
* [*Friday the 13th*](https://fridaythe13th.fandom.com/wiki/Friday_the_13th_Wiki)
* [*Visage*](https://visage.fandom.com/wiki/Visage_Wikia)
* [*Darkwood*](https://darkwood.fandom.com/wiki/Darkwood_Wiki)
* [*Five Nights at Freddy's*](https://freddy-fazbears-pizza.fandom.com/wiki/Five_Nights_at_Freddy%27s_Wiki) Series
* [*Phasmophobia*](https://phasmophobia.fandom.com/wiki/Main_Page)
* [*Doll Eye*](https://doll-eye.fandom.com/wiki/Doll_Eye_Wiki)
* [*Bendy*](https://bendy.fandom.com/wiki/Bendy_Wiki) Duology
* [*Poppy Playtime*](https://poppy-playtime.fandom.com/wiki/Poppy_Playtime_Wiki)
* [*Dark Deception*](https://dark-deception-game.fandom.com/wiki/Dark_Deception_Wiki)
* *Granny*
...
* "9-Volt: Quest in the Dark" from WarioWare 8: Move It!

## Resources

### Communities

* [Reddit](https://www.reddit.com/r/horror/)

## Gallery

Poster of the movie *The Suicide Shop*

Poster of the movie *Beetlejuice*
