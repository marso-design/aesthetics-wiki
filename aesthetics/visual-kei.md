...
_Also known as: VK, V-Kei, V系_

Needs Work 🛠️

This page requires improvement. Please help us by [expanding it](https://aesthetics.fandom.com/wiki/Visual_Kei?action=edit). If you are unsure how to help, check the article guide [Format and Content](https://aesthetics.fandom.com/wiki/Format_and_Content "Format and Content").  
**Reason:** Various sections (e.g., "Music," "Fashion") need work. Visual Kei is a broad musical movement with different aesthetics, so it is recommended to create separate articles for its subgenres.

**Visual Kei** (ビジュアル系, bijuaru kei), meaning "visual style," is a Japanese music movement that emerged in the 1980s, characterized by its members' use of elaborate costumes, dramatic makeup, and extravagant, often androgynous, hairstyles. It is not a single music genre but rather an overarching aesthetic that encompasses a wide variety of sounds, including those influenced by [glam metal](https://aesthetics.fandom.com/wiki/Hair_Metal "Hair Metal"), [post-punk](https://aesthetics.fandom.com/wiki/Post-punk "Post-punk"), gothic rock, and [industrial](https://aesthetics.fandom.com/wiki/Industrial "Industrial").

The primary unifying principle is an emphasis on visual presentation as an integral and equal component of the musical performance. Pioneered by bands like X Japan and Buck-Tick, the movement drew initial inspiration from Western [Glam Rock](https://aesthetics.fandom.com/wiki/Glam_Rock "Glam Rock"), [Goth](https://aesthetics.fandom.com/wiki/Goth "Goth"), and [Punk](https://aesthetics.fandom.com/wiki/Punk "Punk") but developed into a uniquely Japanese phenomenon.

Over the decades, Visual Kei has evolved into numerous distinct sub-genres (such as the dark and aggressive Nagoya Kei, the bright and colorful [Oshare Kei](https://aesthetics.fandom.com/wiki/Oshare_Kei "Oshare Kei"), and the traditionalist [Angura Kei](https://aesthetics.fandom.com/wiki/Angura_Kei "Angura Kei")) each with its own specific visual and musical codes.
...
Girltique (女的), the earliest known female-fronted visual kei band
...
* Shichi-Henge/The Wallflower

### Movies/ TV Shows

* *Beat Rock☆Love*
* Onegai Kanete Versailles
* oresama
...
* gulu gulu ***(disbanded)***
* HERO
* Hyakumonogatari ***(Hiatus)***
* Janne Da Arc ***(disbanded)***
* JILL-PRINCE
* JILUKA
* Jupiter
* Kamijo
...
* Leetspeak monsters
* LM.C
* LOVE DIVING ***(fictional Visual Kei band from the movie Beat Rock☆Love)***
* Luna Sea
* Madmans Espirit
* Malice Mizer ***(inactive)***
* Mejibray ***(disbanded)***
* Mix Speaker's,Inc. ***(disbanded)***
* Miyavi
* Moi Dix Mois
* MUCC
* NETH PRIERE CAIN
...
* Schwartz Stein
* Shazna
* SIAM SHADE ***(disbanded)***
* SID
* SuG ***(disbanded)***
* Sukekiyo
* The GazettE
* Versailles ***(disbanded)***
* vistlip
* X-Japan
* zigzag
...
* [Visual Kei Mix](https://open.spotify.com/playlist/37i9dQZF1EIeKfeI4kVwCE) (Spotify Niche MIx)
* [Oshare Kei Mix](https://open.spotify.com/playlist/37i9dQZF1EIgdBfp39HVpi) (Spotify Niche Mix)

## Resources

* [VisuNavi](https://www.visunavi.com/)
* [VKGY](https://vk.gy/)
* [JROCK'N'ROLL](https://jrocknroll.com/interview-with-nagasawa-tomonori/) (*interview with Nagasawa Tomonori*)
* [J-Rock News](https://jrocknews.com/)

### Communities

* [Facebook](https://www.facebook.com/groups/790124977711201/)
* [Reddit](https://www.reddit.com/r/visualkei/)

### Vendors

* [Algonquins](http://www.algonquins.jp/)
* [Deorart](https://www.deorart-shop.jp/)
* [Hell Cat Punks](https://www.hellcatpunks.com/)
* [h.NAOTO](https://hnaoto.com/)
* [Punk Rave](https://www.punkravestore.com/)
* [Sex Pot Revenge](http://sexpot.jp/)

## Gallery

Exist Trace (an all-female Neo Visual Kei band) performing in Pittsburgh in 2012.
