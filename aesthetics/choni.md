...
This classist double standard is highlighted by the fact that the negative connotations associated with "*choni*" are stronger than those associated with "*[pija](https://aesthetics.fandom.com/wiki/Pijo "Pijo")*" (the Spanish equivalent of a posh/[preppy](https://aesthetics.fandom.com/wiki/Preppy "Preppy") person), as the working class is more socially stigmatized. The case of Naiara, a winner of the show *Operación Triunfo*, is a key example of this. Despite adopting elements of the aesthetic, her talent and charisma challenged the stereotype, proving that these stylistic choices do not define a person's worth or talent. Due to its harmful impact, there has been a growing call to remove the word "*choni*" from everyday language.
