...
name: "Goreweb"
slug: "goreweb"
aka: ["Chaoscore", "AGC Style", "LiveLeakcore"]
...
_Also known as: Chaoscore, AGC Style, LiveLeakcore_
...
**Reason for Warning:** This page documents a visual aesthetic centered on shock value and the stylization of graphic violence. The article contains descriptions and examples of simulated gore, medical horror, weaponry, and imagery mimicking real-world shock sites (e.g., LiveLeak). While the content discussed is primarily performative or stylized, the aesthetic is intentionally designed to be disturbing and desensitizing. Reader discretion is strongly advised.

**Goreweb**, also known as **Chaoscore**, is an internet aesthetic and visual subgenre of [Opium](https://aesthetics.fandom.com/wiki/Opium "Opium") that originated in the 2020s. It is defined by the recontextualization of "shock site" imagery (specifically the low-resolution, gory visual language of mid-2000s platforms like LiveLeak and Rotten.com) into a high-fashion or "hype" context.

Popularized heavily by rapper Ken Carson during the promotional cycle for his 2023 album *A Great Chaos*, the aesthetic blends the "edgy" nostalgia of early internet horror (Creepypastas, Cursed Images) with the luxury darkness of modern streetwear. Unlike [Traumacore](https://aesthetics.fandom.com/wiki/Traumacore "Traumacore"), which utilizes similar imagery to express vulnerability, Goreweb utilizes it to project aggression, desensitization, and a chaotic "rockstar" lifestyle.

## History

### Precursors (The Yabujin Era)

Before entering the mainstream hip-hop sphere, the "Goreweb" visual style was pioneered in the underground by artists like Yabujin and the Reptilian Club Boyz (RCB); see [Xpiritualism](https://aesthetics.fandom.com/wiki/Xpiritualism "Xpiritualism") and [HexD](https://aesthetics.fandom.com/wiki/HexD "HexD"). These artists utilized a similar blend of "Web 1.0" horror and "Jumpstyle Revival" aesthetics, often referencing the flash game era and early YouTube horror channels like nana825763 (creator of username666). Yabujin's "Azeroy" aesthetic established the blueprint of mixing medical gore with ethereal digital nostalgia.

### The "Great Chaos" Era (2023–Present)
...
The mainstreaming of Goreweb sparked significant controversy within underground communities. Fans of Yabujin and Drain Gang accused Ken Carson of "biting" (plagiarizing) the visual style of the "[Xpiritualism](https://aesthetics.fandom.com/wiki/Xpiritualism "Xpiritualism")" and "[HexD](https://aesthetics.fandom.com/wiki/HexD "HexD")" scenes without crediting the originators. Critics argued that while Yabujin used the aesthetic to explore surrealism and nostalgia, the "[Opium](https://aesthetics.fandom.com/wiki/Opium "Opium")" version commodified it into a generic "edgy" brand filter.
...
* [Ken Carson](https://www.instagram.com/kencarson/)
* [Webgore](https://www.instagram.com/webgores/)
* [agreatchaos](https://www.instagram.com/agreatchaos/)
* [nickspiders](https://www.instagram.com/nickspiders/)
* [itwsnvrcrystlclr](https://www.instagram.com/itwsnvrcrystlclr/)

### TikTok Artists

* [vspbennalt](https://www.tiktok.com/@vspbennalt)

### YouTube

* [nana825763](https://www.youtube.com/@nana825763)
  + [username666](https://www.youtube.com/watch?v=7iFXyLah2oQ) (by nana825763)
* [fighting my demons music video](https://www.youtube.com/watch?v=YKkMR2l05Rs) (by Ken Carson)
* [jennifer's body music video](https://www.youtube.com/watch?v=CSMiPngo4uE) (by Ken Carson)
* [Snuff Films do not exist](https://www.youtube.com/watch?v=WO_LgaQAVnE) (by snuffilms)
* [Cursed Video](https://www.youtube.com/watch?v=-uY6yhGWwok) (by Chris Sadler)
* [AGC Group Collab](https://www.youtube.com/watch?v=bnJYBGowH1k) (by Rare Ent)
...
AGC fan art (artist unknown)

@webgore on Instagram
