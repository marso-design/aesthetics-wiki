...
name: "Tomboy"
slug: "tomboy"
aka: ["Cool-Girl", "Masculine Girl", "Boyish Girl"]
...
_Also known as: Cool-Girl, Masculine Girl, Boyish Girl_

Needs Work 🛠️

This page requires improvement. Please help us by [expanding it](https://aesthetics.fandom.com/wiki/Tomboy?action=edit). If you are unsure how to help, check the article guide [Format and Content](https://aesthetics.fandom.com/wiki/Format_and_Content "Format and Content").  
**Reason:** This page requires a comprehensive overhaul to move to focus on the actual modern tomboy aesthetic. The current version functions as a broad conceptual and activity dump, including uncurated lists of nearly every imaginable hobby and retailer, which fails to describe the specific fashion motifs. The extensive lists of media and stores must be drastically trimmed to include only relevant brands, not every possible concept or item associated with the term "tomboy".
...
* Yelena Belova *(Thunderbolts / Marvel)*
...
* [Reddit](https://www.reddit.com/r/Tomboys/)

### Vendors

* [TomboyX](https://tomboyx.com/)
* [Kirrin Finch](https://kirrinfinch.com/)
