---
name: "Catholic Mexican Girl"
slug: "catholic-mexican-girl"
aka: ["Latina Fairy", "Mexican Fairy"]
...
_Also known as: Latina Fairy, Mexican Fairy_
...
**Reason for Warning:** This aesthetic involves the secular recontextualization of sacred Catholic iconography, which may be considered offensive or sacrilegious to religious practitioners. Additionally, this page discusses a trend heavily criticized for romanticizing the Spanish colonial era.

The **Catholic Mexican Girl** aesthetic, also known as **Latina Fairy**, is a fashion [microtrend](https://aesthetics.fandom.com/wiki/Microtrend "Microtrend") that originated in 2023 on TikTok. It blends the hyper-feminine elements of the [Coquette](https://aesthetics.fandom.com/wiki/Coquette "Coquette") aesthetic with a romanticized interpretation of traditional Mexican and Spanish colonial imagery. The trend is characterized by the use of religious iconography as fashion accessories, distinct hair braiding styles, and attire that references the "Old World" colonial era of the Americas, specifically the region historically known as New Spain.
...
- `images/catholic-mexican-girl/Nscg.png`
- `images/catholic-mexican-girl/Nscg4.jpg`
- `images/catholic-mexican-girl/Nscg2.jpg`
- `images/catholic-mexican-girl/Nscg3.jpg`

## Source and attribution

Text adapted from "Catholic Mexican Girl" on the Aesthetics Wiki (https://aesthetics.fandom.com/wiki/Catholic_Mexican_Girl), licensed CC-BY-SA 4.0. Retrieved 2026-07-22. Images retain their individual licenses; see the local `credits.json`.
