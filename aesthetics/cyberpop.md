...
_Also known as: Cyber_

Needs Work 🛠️

This page requires improvement. Please help us by [expanding it](https://aesthetics.fandom.com/wiki/Cyberpop?action=edit). If you are unsure how to help, check the article guide [Format and Content](https://aesthetics.fandom.com/wiki/Format_and_Content "Format and Content").

**Cyberpop** is a retro-futuristic style that first emerged in Japan during the 90s under the more generic name "cyber fashion" (サイバーファッション). It is characterized by some fantasy, [Y2K Futurism](https://aesthetics.fandom.com/wiki/Y2K_Futurism "Y2K Futurism"), a positive aura, and a stylized clean outline, as opposed to [Cyberpunk](https://aesthetics.fandom.com/wiki/Cyberpunk "Cyberpunk") and [Cybergoth](https://aesthetics.fandom.com/wiki/Cybergoth "Cybergoth"), which is rather negative and dark (post-apocalyptic).

## Fashion

The key difference between [Cybergoth](https://aesthetics.fandom.com/wiki/Cybergoth "Cybergoth") and Cyberpop fashion is that the latter mainly focuses on bright colors. Cyberpop also contains more elements of Space Age in the usage of retro-future rings and shoulder puffs. The 1990s and early 2000's future fashion aesthetic found in [Y2K Futurism](https://aesthetics.fandom.com/wiki/Y2K_Futurism "Y2K Futurism") is also influential. The color palette is similar to the one used in the [Kandi Raver](https://aesthetics.fandom.com/wiki/Kandi_Raver "Kandi Raver") aesthetic, but differs in that natural materials are never used. Both [Kandi Raver](https://aesthetics.fandom.com/wiki/Kandi_Raver "Kandi Raver") and Cyberpop fashion makes use of neon colored UFO pants, both wide legged and drawstring.
...
* Hairclips in the more [Decora](https://aesthetics.fandom.com/wiki/Decora "Decora")-leaning outfits but with a focus on space themed motifs such as stars, planets, and starships
...
* [HYPERSONIC Music Club](https://hypersonic-comic.tumblr.com/) (2015)
...
* Butterflies by iris day
* goreblog by 8485 ft. ​bod [包家巷] & Glasear **(NSFW lyrics warning)**
...
* [Product\_C](http://www.pdc-design.com/)
* [Takuya Angel](http://takuya-angel.com/)

## Gallery

Cyber fashion during the 90s

HEAVY POP flyer featuring a Cyberpop model

A holographic butterfly hairpin

Kiss Me Kill Me outfit display

Bunny ears in Cyberpop style

Black Sunshine corset by Bubble Fusion

The widely used shield necklace in various colors
