...
Remember to check [what links here](https://aesthetics.fandom.com/wiki/Special:WhatLinksHere/Heistcore "Special:WhatLinksHere/Heistcore") and [the page history](https://aesthetics.fandom.com/wiki/Heistcore?action=history) before deletion.  
**Reason:** This page is a category error that misclassifies a genre of fiction as a curatable aesthetic. It is an uncritical conceptual dump that documents the tropes, props, and plots of heist movies and real-life crimes, rather than a cohesive visual style. The page lacks a reproducible fashion canon and its content belongs on a different kind of wiki (e.g., a film or crime wiki), not an aesthetics wiki. The page is uncuratable and violates the wiki's core principles of focused documentation, similar to invalid pages like "[Spy Fiction](https://aesthetics.fandom.com/wiki/Spy_Fiction "Spy Fiction")" or "[Zombie Apocalypse](https://aesthetics.fandom.com/wiki/Zombie_Apocalypse "Zombie Apocalypse")".

**Heistcore** is associated with thieves and heists, the elaborate thefts of data, money, art, jewels, and historical documents. Heistcore aesthetics can be found in espionage, crime, and detective media. Because of the value of the stolen goods, heists are considered more high class than cons in general. The title **Gentleman Thief** is sometimes applied to males who participate in heists, especially in media set during the [Golden Age of Detective Fiction](https://aesthetics.fandom.com/wiki/Golden_Age_of_Detective_Fiction "Golden Age of Detective Fiction"). The female equivalent is the **Cat Burglar**.

## History

In fiction, heists are a major part of the [caper](https://tvtropes.org/pmwiki/pmwiki.php/Main/TheCaper) genre. Thieves and heists appear in literature as far back as medieval times, with the creation of the Robin Hood character in English folklore.
...
Heistcore has a dark, deep, and metallic color palette. Colors include black, tan, cream, gold, silver, and jewel tones like deep red, blue, and green. The aesthetic of wealth, both the nouveau riche and [Old Money](https://aesthetics.fandom.com/wiki/Old_Money "Old Money"), appears in Heistcore due to the wealthy often being the mark, or victim of the heist in question.
...
* [Bag Borrow or Steal](https://www.bagborroworsteal.com/)
* [Metal Masters Co.](https://metalmastersco.com)
...
* [British Museum shop](https://www.britishmuseumshoponline.org/)
* [Fine Arts America](https://fineartamerica.com/art/paintings/replica)
* [Guggenheim Museum Store](https://www.guggenheimstore.org/)
* [The LACMA Store](https://www.thelacmastore.org/)
* [Louvre Online Store](https://boutique.louvre.fr/?lang=en)
* [Met Museum Online Store](https://store.metmuseum.org/)
* [MoMA Design Store](https://store.moma.org/)
* [SFMOMA Museum Store](https://museumstore.sfmoma.org/)
* [Tate Online Shop](https://shop.tate.org.uk/)
* [Whitney Shop](https://shop.whitney.org/)
...
* Asking for a raise
* Couponing
* Donating to [RIP Medical Debt](https://ripmedicaldebt.org/) - you’ll feel like Robin Hood, "robbing from the rich and giving to those in need"
* Geocaching
...
Nicholas Cage creates a fake ID card in National Treasure using Photoshop

## Resources

* [Art Loss Register](https://www.artloss.com/)
* [Art theft on Wikipedia](https://en.wikipedia.org/wiki/Art_theft)
* [Art Recovery International](https://www.artrecovery.com/)
* [Commission for Looted Art in Europe](https://www.lootedartcommission.com/)
