...
related_media: ["Lollapalooza Argentina"]
source_url: "https://aesthetics.fandom.com/wiki/Milipili"
...
_Also known as: Cheta, Tincho (male variant)_

Needs Work 🛠️

This page requires improvement. Please help us by [expanding it](https://aesthetics.fandom.com/wiki/Milipili?action=edit). If you are unsure how to help, check the article guide [Format and Content](https://aesthetics.fandom.com/wiki/Format_and_Content "Format and Content").

**Milipili** is a youth subculture and fashion aesthetic that emerged in Argentina in the early 2020s and gained viral popularity on platforms like TikTok. The name is a portmanteau of "Milagros" and "Pilar," two personal names common among the Argentine upper class, and the term is used to describe a style and social group associated with affluent, trend-conscious young women.

The aesthetic is a maximalist and often revealing reinterpretation of late 1990s and early 2000s fashion, blending elements of [Y2K](https://aesthetics.fandom.com/wiki/Y2K "Y2K") and [McBling](https://aesthetics.fandom.com/wiki/McBling "McBling"). The uniform is characterized by garments like low-rise pants, crop tops, ripped or distressed clothing, and platform boots. While initially a pejorative term for conceited, wealthy youth, "Milipili" has evolved to primarily describe this specific fashion trend, which is heavily shown at music festivals like Lollapalooza Argentina.

## Visuals

* A lot of "total black"
* Low-waisted pants
* Cargo pants
* Mini skirts
* Military boots
* High boots
* Very short tops that expose the entire belly
* Accesories such as gloves and chains

## Fashion

Some common elements of Milipili fashion are:
...
* "Miénteme" by TINI and Maria Becerra
* "La Triple T" by TINI
* "cuatro veinte" by Emilia
* "No\_se\_ve.mp3" by Emilia, Ludmilla, and Zecca
* "AUTOMÁTICO" by Maria Becerra
* "Muñecas" by TINI, La Joaqui, and Steve Aoki
* "La\_Original.mp3" by Emilia and TINI
* "N5" by Lali
* "High (Remix)" by Maria Becerra, TINI, and Lola Indigo
* "Los del Espacio" by LIT killah, Tiago PZK, Maria Becerra, Duki, Emilia, Rusherking, Big One, and FMK
* "Carita Triste" by Emilia and Ana Mena
* "Discoteka" by Lola Indigo and Maria Becerra
* "En La Intimidad" by Emilia, Big One, and Callejero Fino
* "Cupido" by TINI
* "Exclusive.mp3" by Emilia

## Gallery

[Tini](https://en.wikipedia.org/wiki/Tini_(singer)) (stylized as TINI) is known for adapting to this style in her concerts and other events. Her music is pretty well known between the 'milipili' environment.

[Maria Becerra](https://en.wikipedia.org/wiki/Mar%C3%ADa_Becerra) is an example of a 'milipili' who wasn't born in an upper class and started from below, since many 'milipilis' are treated as "capricious girls".

[Emilia Mernes](https://en.wikipedia.org/wiki/Emilia_Mernes), known mononymously as Emilia, is a famous singer who acted as one of the initiators of this fashion style.

[Lali Espósito](https://es.m.wikipedia.org/wiki/Lali_Esp%C3%B3sito#:~:text=Mariana%20%C2%ABLali%C2%BB%20Esp%C3%B3sito%20), an Argentine singer who also tends to have this style, is here dressed up to go to [BRESH](https://www.fiestabresh.com/) a typical Milipili party.

[Sabrina Carpenter](https://en.wikipedia.org/wiki/Sabrina_Carpenter), for The Eras Tour, Buenos Aires night 2, dressed by stylist and creative director [Manon Desouse](https://www.instagram.com/manondesouse/), who uses a very similar aesthetic for her creations.

[Julieta Poggio](https://en.wikipedia.org/wiki/Julieta_Poggio), one of the competitors from Big Brother Argentina, is very known for having this style.

Emilia, previously mentioned, made rhinestone lips a trend in April of 2024. Thanks to being an artist popular in the milipili scene, rhinestone lips quickly became a fashion accessory within it (although she confirmed that she swallowed a rhinestone while eating a hamburger, but seemed okay).
...
- `images/milipili/Milipili.png`
- `images/milipili/Milipili3.png`
- `images/milipili/Milipili2.png`
- `images/milipili/Milipili1.jpg`

## Source and attribution

Text adapted from "Milipili" on the Aesthetics Wiki (https://aesthetics.fandom.com/wiki/Milipili), licensed CC-BY-SA 4.0. Retrieved 2026-07-22. Images retain their individual licenses; see the local `credits.json`.
