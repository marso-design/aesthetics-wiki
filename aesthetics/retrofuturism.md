...
As a broad conceptual framework, Retrofuturism encompasses various distinct subgenres, each rooted in a specific historical period's technological outlook. These include [Steampunk](https://aesthetics.fandom.com/wiki/Steampunk "Steampunk") (Victorian-era visions), [Dieselpunk](https://aesthetics.fandom.com/wiki/Dieselpunk "Dieselpunk") (interwar period, 1920s-1940s visions), [Raygun Gothic](https://aesthetics.fandom.com/wiki/Raygun_Gothic "Raygun Gothic") (Art Deco-influenced future), [Space Age](https://aesthetics.fandom.com/wiki/Space_Age "Space Age") (optimistic space race 1950s-1960s visions), [Atompunk](https://aesthetics.fandom.com/wiki/Atompunk "Atompunk") (Cold War, 1950s-1960s visions), [Cassette Futurism](https://aesthetics.fandom.com/wiki/Cassette_Futurism "Cassette Futurism") (1970s-1980s, late Cold War era), [Cyberpunk](https://aesthetics.fandom.com/wiki/Cyberpunk "Cyberpunk") (1980s-1990s, digital-age visions), [Y2K Futurism](https://aesthetics.fandom.com/wiki/Y2K_Futurism "Y2K Futurism") (late 1990s-early 2000s, tech anticipation), and [Frutiger Aero](https://aesthetics.fandom.com/wiki/Frutiger_Aero "Frutiger Aero") (mid-2000s-early 2010s, eco-friendly tech visions). Each of these subsets focuses on specific technological themes and cultural anxieties from their respective eras of origin, while still operating under the broader Retrofuturist principle.
...
From the 1990s into the 21st century, retrofuturism became a widely used umbrella for many substyles and media practices, from [Dieselpunk](https://aesthetics.fandom.com/wiki/Dieselpunk "Dieselpunk") and [Atompunk](https://aesthetics.fandom.com/wiki/Atompunk "Atompunk") to [Raygun Gothic](https://aesthetics.fandom.com/wiki/Raygun_Gothic "Raygun Gothic") architecture, from fashion that quotes 1960s Space Age designers to films and games set in alternate technological timelines. It also shifted from being mainly a commentary on past optimism to a way of processing disappointment, highlighting the gap between the sleek futures people once expected and the more complicated, messy present that actually arrived.
...
* *Atomic Heart* (2023)
* *Bioshock* franchise (2007-2013)
* *Fallout* franchise (1997-present)
* *Grim Fandango* (1998)
* *Psychonauts* duology (2005-2021)
* *The Outer Worlds* (2019)
* *Wolfenstein* franchise (1981-present)
* *We Happy Few* (2018)
...
* **EPCOT** located at Walt Disney World Resort

#### Themed Lands

* **Discoveryland** located in Disneyland Park, Disneyland Paris
* **Port Discovery** located in Tokyo DisneySea theme park, Tokyo Disney Resort
* **Tomorrowland** located in
  + Disneyland theme park, Disneyland Resort
  + Hong Kong Disneyland theme park, Hong Kong Disneyland Resort
  + Magic Kingdom theme park, Walt Disney World Resort
  + Shanghai Disneyland theme park, Shanghai Disney Resort
  + Tokyo Disneyland theme park, Tokyo Disney Resort
...
* [r/RetroFuturism](https://www.reddit.com/r/RetroFuturism/) on Reddit

## Gallery

Maison des Gardes Agricoles, by Claude-Nicolas Ledoux, 1804, etching

Illustration showing Thomas Edison's anti-gravitation under-clothing, unknown illustrator, 1870s, etching

Illustration from La Vie Electrique, page 51, by Albert Rodida, 1893, print

Illustration from La Vie Electrique, page 171, by Albert Rodida, 1893, print

Night at the opera in the year 2000, by Albert Robida, c.1902, hand-colored lithograph

Rue Réaumur no. 124, Paris, an unusual [Art Nouveau](https://aesthetics.fandom.com/wiki/Art_Nouveau "Art Nouveau") building that anticipates the [Steampunk](https://aesthetics.fandom.com/wiki/Steampunk "Steampunk") aesthetic, by Georges Chedanne, 1904

Poster for La Guerre des Mondes (The War of the Worlds), by Henrique Alvim Corrêa, 1906, ink on paper

France in the year 2000 - Madame at her toilette, by Villemard, 1910, chromolithography on paper card

France in the year 2000 - Correspondance cinema, by Villemard, 1910, chromolithography on paper card

Scene from The Metropolis, by Fritz Lang, 1927

Bucharest in the year 2000: view of Calea Victoriei with the CEC Palace in the left, unknown illustrator, 1930, print

Bucharest in the year 2000, imagined in 1930: view of the University Square with the university building in the left and the statue of Michael the Brave in the right, unknown illustrator, 1930, print

House of the Future, Disneyland, Anaheim, USA, by the Monsanto Chemical Company, 1957

Illustration of a Reader's Digest cover, unknown illustrator, 1966, print

Villa Spies, Törö, Sweden, by Staffan Berglund, 1968-1969

Plan for an Underground Nuclear Shelter, by Oscar Newman, 1969, probably watercolour

Futuro House, Philadelphia, USA, by Matti Suuronen, 1970

The City of the Captive Globe, by Rem Koolhaas, Zoe Zenghelis and Madelon Vriesendorp, 1972, probably watercolour

[Codsworth](https://fallout.fandom.com/wiki/Codsworth) from [Fallout 4](https://en.wikipedia.org/wiki/Fallout_4)
