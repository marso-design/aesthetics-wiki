...
slug: "suburban-gothic"
decade_of_origin: "1950s"
key_motifs: ["Suburban neighborhoods", "streetlamps", "grocery and convenience stores", "and fluorescent lighting"]
key_colours: ["White", "black", "gray", "blue", "red", "and green"]
key_values: ["Alienation", "capitalist critique", "facades", "uncanny"]
related_aesthetics: ["50s Suburbia", "After Hours", "Anglo Gothic", "Cryptidcore", "Midwest Gothic", "Southern Gothic", "Deathrock", "Liminal Space", "Weirdcore", "Dreamcore", "Traumacore", "Dollar Store Vernacular", "Australian Gothic"]
...
**Suburban Gothic** is an aesthetic based around feelings of alienation and the uncanny, usually represented in being alone in suburban neighborhoods. Common motifs include coming-of-age, familial/generational trauma, facades, and the shallowness of capitalistic culture.
...
While sharing similar traits with [Southern Gothic](https://aesthetics.fandom.com/wiki/Southern_Gothic "Southern Gothic") and [Midwest Gothic](https://aesthetics.fandom.com/wiki/Midwest_Gothic "Midwest Gothic"), there is no specific region or nation that appears prominently in suburban gothic. The aesthetic has its origins in literature, film, and television, but later gained a visual aesthetic and more examples through short bullet-pointed lists with the regional gothic trend on Tumblr in the mid-2010s. In this version, there is a heavy emphasis on the use of [Liminal Space](https://aesthetics.fandom.com/wiki/Liminal_Space "Liminal Space"), supernatural beings, and tropes typically found in suburban culture, such as housewives and cheerleaders.
...
For more, see the [TVTropes page](https://tvtropes.org/pmwiki/pmwiki.php/Main/SuburbanGothic).
...
* *The Twilight Zone* (1959-1964) (specifically episodes centring around suburbia, such as "The Monsters are Due on Maple Street")
...
* *Goosebumps* (2023)
* *Shaun Tan's tales from outer suburbia* (2026-)
* *The 'Burbs* (2026-)

### Other Media

* *Welcome Home* (Multi-Media Project and ARG by [partycoffin](https://www.tumblr.com/partycoffin))
* Wallsocket (Underscores album and accompanying ARG)
...
* Nicole Dollanganger
* The Shaggs
* Scott Bradlee's Postmodern Jukebox (specifically song covers in 1940s/1950s styles, such as *["Die With A Smile"](https://youtu.be/mJSkbeQhuE4?si=Mlmyp3zaezICltOq)*)
* Billy Joel
...
* [r/Suburban\_Gothic\_Art](https://www.reddit.com/r/Suburban_Gothic_Art/)
