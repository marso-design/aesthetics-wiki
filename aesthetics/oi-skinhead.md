...
name: "Oi! Skinhead"
slug: "oi-skinhead"
aka: ["Street Punk Skin", "80s Skinhead", "Second Wave Skinhead"]
...
_Also known as: Street Punk Skin, 80s Skinhead, Second Wave Skinhead_
...
**Reason for Warning:** This page documents a subculture that was historically a battleground for political extremism. The content discusses the infiltration of the scene by far-right and white nationalist groups (such as the National Front) during the late 1970s and 1980s, as well as instances of severe street violence and riots. While the Oi! aesthetic itself is not inherently racist, its history is inextricably linked to these controversies. Viewer discretion is advised.

**Oi! Skinhead** represents the "Second Wave" of the [skinhead](https://aesthetics.fandom.com/wiki/Skinhead "Skinhead") subculture that emerged in the United Kingdom during the late 1970s. This era marked a definitive visual and musical break from the earlier [Trojan Skinhead](https://aesthetics.fandom.com/wiki/Trojan_Skinhead "Trojan Skinhead") style, moving away from 1960s soul and reggae toward a harder, aggressive fusion of punk rock and working-class street culture. The subculture was built on a foundation of "boot-to-the-bollocks rage" and a fierce rejection of the perceived "art school" intellectualization of the early UK [punk](https://aesthetics.fandom.com/wiki/Punk "Punk") scene.
...
* **Outerwear:** The nylon MA-1 flight jacket (bomber) in olive green or black became the standard garment. Many skins also wore donkey jackets, a piece of traditional British industrial workwear, to emphasize their proletarian roots.
* **Denim:** Jeans were typically worn tight and cuffed to show the boots. Bleached denim—achieved by splattering bleach on dark jeans to create a "snowflake" or "camo" effect—became a hallmark of the era.
* **Footwear:** High-lace Dr. Martens (10-hole or higher) were preferred, often shined to a parade gloss. In some instances, laces were color-coded to signify various identities, though this practice was often inconsistent and misunderstood by those outside the scene.
* **Accessories:** Thin braces (suspenders) were worn over T-shirts or polo shirts, sometimes worn hanging down off the shoulders. Tattoos became more visible, often appearing on the neck, hands, or face.
...
The scene faced a disastrous turning point on July 4, 1981, when a riot occurred at an Oi! concert in Southall. The venue was burned down by local Asian youth who believed the event (featuring bands like The 4-Skins and The Business) was a neo-Nazi provocation. This incident, combined with the release of the *Strength Thru Oi!* compilation (which featured a known far-right activist on the cover), led to a lasting public perception that the entire [Skinhead](https://aesthetics.fandom.com/wiki/Skinhead "Skinhead") subculture was racist.
...
* "Suburban Rebels" by The Business
* "Someone's Gonna Die Tonight" by Blitz
* "Violence In Our Minds" by Last Resort
* "The Kids Are United" by Sham 69
* "I'm An Upstart" by Angelic Upstarts
* "Police Oppression" by Angelic Upstarts

## Distinction from [Trojan Skinhead](https://aesthetics.fandom.com/wiki/Trojan_Skinhead "Trojan Skinhead")

The Oi! aesthetic is characterized by a more rugged, "hard-boiled" appearance compared to the polished [Mod](https://aesthetics.fandom.com/wiki/Mod "Mod")-influenced look of the 1969 ["Spirit of '69"](https://aesthetics.fandom.com/wiki/Trojan_Skinhead "Trojan Skinhead") era.

| **Feature** | **[Trojan / Trad Skin](https://aesthetics.fandom.com/wiki/Trojan_Skinhead "Trojan Skinhead") (1960s)** | **Oi! / 80s Skin (1980s)** |
| --- | --- | --- |
| **Hair** | #2 to #4 crop (visible hair) | #0 to #1 shave (bald or stubble) |
| **Jackets** | Harringtons, Crombie-style, Sheepskin | MA-1 Flight Jackets (Nylon Bombers), Donkey Jackets |
| **Pants** | Levi's 501, Sta-Prest trousers | Bleached jeans, splattered "drainpipes" |
| **Boots** | 8-hole Dr. Martens (Black/Cherry) | 10 to 20-hole boots, often highly polished |
| **Music** | Reggae, Ska, Rocksteady, Soul | Oi!, Street Punk, Hardcore |
...
| Skinheads |
| [Traditional](https://aesthetics.fandom.com/wiki/Skinhead "Skinhead") • Bootboy • Smoothie • **Oi! Skinhead** • Redskin • SHARP • [Suedehead](https://aesthetics.fandom.com/wiki/Suedehead "Suedehead") • [Trojan Skinhead](https://aesthetics.fandom.com/wiki/Trojan_Skinhead "Trojan Skinhead") • White Power Skinhead |
| Regional: Americas |
