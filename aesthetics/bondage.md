...
_Also known as: BDSM_

Needs Work 🛠️

This page requires improvement. Please help us by [expanding it](https://aesthetics.fandom.com/wiki/Bondage?action=edit). If you are unsure how to help, check the article guide [Format and Content](https://aesthetics.fandom.com/wiki/Format_and_Content "Format and Content").  
**Reason:** This page is currently a content dump that incorrectly treats a broad practice as a single, cohesive aesthetic. The content is uncurated and inappropriately pulls examples from many distinct subcultures (Goth, Pin-up, etc.) that use bondage imagery, making the page redundant to more specific entries. It must be rewritten to focus on the aesthetics of the practice itself, acting as a hub for a motif rather than a flawed aesthetic entry. Its extensive, uncurated lists of media and music also need to be heavily pruned to be more relevant and focused.
...
**Reason for Warning:** This page documents a practice and aesthetic centered on Bondage (BDSM/Fetish) and power exchange. The content features explicit themes of sexual restraint and control, including the use of fetish equipment (e.g., gags, harnesses, spreader bars) and references to media that may include non-consensual or highly aggressive sexual imagery. Viewer discretion is strongly advised.

**Bondage**, the practice of using restraints such as ropes or leather to restrict movement, has evolved beyond its origins in kink spaces to become a distinct aesthetic. Previously a taboo subject, it has found expression within various subcultures, notably [Goth](https://aesthetics.fandom.com/wiki/Goth "Goth"), which was among the first non-kink communities to incorporate elements of this aesthetic. The appeal of bondage as an aesthetic lies in the craftsmanship of ropework and leather, and the visual representation of power dynamics. It explores the tension between constraint and freedom, challenging conventional notions of beauty. Bondage imagery appears in various aesthetic and subcultural expressions.
...
* Collars (dog collars, studded collars, O-ring collars, chains w/locks, etc.), sometimes with leashes
* Wrist/ankle cuffs
* Harnesses (usually either leather or rope/shibari)
...
* Spreader bars
* Leather clothing
* Chains/clothes with chains (usually silver)
* Catsuits
* Leather boots
* Black and red clothing
* Gags (ball gags, O-ring gags, etc.)
...
A [kawaii](https://aesthetics.fandom.com/wiki/Kawaii "Kawaii")-style shibari keychain

Publicized BDSM fashion

The roleplay of being arrested is very common.

Dom the Dom from Saints Row IV
