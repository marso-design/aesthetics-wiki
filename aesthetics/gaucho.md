...
name: "Gaucho"
slug: "gaucho"
aka: ["Gaúcho (in Brazil)"]
decade_of_origin: "18th Century"
key_motifs: ["Poncho", "facón (knife)", "bombachas de campo (trousers)", "boleadoras", "horses", "mate gourd", "open plains (Pampas)"]
key_colours: ["Earthy tones", "muted reds and blues", "black", "white"]
key_values: ["Independence", "freedom", "bravery", "self-reliance", "equestrian skill", "national pride"]
related_aesthetics: ["Western", "Country", "Prairie"]
...
_Also known as: Gaúcho (in Brazil)_
...
The **Gaucho** is a historical and cultural figure of the South American Pampas (grasslands), equivalent to the North American [cowboy](https://aesthetics.fandom.com/wiki/Western "Western"). Originating in the 18th century, the Gaucho was a nomadic and skilled horseman, traditionally of mixed European and indigenous ancestry, who roamed the plains of what is now Argentina, Uruguay, and Southern Brazil. The subculture is defined by a fierce spirit of independence, equestrian skills, and a distinct, practical form of dress.
...
* **Poncho:** A versatile and essential outer garment, the poncho served as a coat, a blanket, and a shield from the elements.
* **Bombachas de Campo:** These are wide, loose-fitting trousers, often pleated and buttoned at the ankle, which allow for comfort and freedom of movement while riding a horse.
* **Facón:** A large, heavy knife, typically worn tucked into the back of the waistband. It was an all-purpose tool and a primary weapon for self-defense.
* **Boots and Hat:** Gauchos wore a wide-brimmed hat for protection from the sun and tall leather boots, sometimes of the *bota de potro* style, which were made from the skin of a horse's leg.
* The **boleadoras**, a throwing weapon made of weighted leather cords, was a signature tool for hunting and capturing cattle. A constant companion was the **mate gourd** and **bombilla** (metal straw), used for drinking yerba mate, a traditional caffeinated infusion part of the culture of the region.
