...
**Juminocore** is an internet aesthetic that originated on platforms like Pinterest and TikTok around 2024. It is centered on the collection and curated display of Japanese [kawaii](https://aesthetics.fandom.com/wiki/Kawaii "Kawaii") (cute) goods, particularly small toys and trinkets from the Heisei era (1989–2019). The aesthetic is defined by its specific, often muted color palette and its presentation through a modern, Western social media lens, rather than from an authentic Japanese perspective.
...
## Distinction from Heisei Retro

A central point of discussion is the difference between Juminocore and [Heisei Retro](https://aesthetics.fandom.com/wiki/Heisei_Retro "Heisei Retro"). While both utilize the same objects, they are considered distinct cultural phenomena.

* Heisei Retro is a broad and authentic **nostalgic movement within Japan**, created by and for Japanese people who grew up during the Heisei era (1989-2019). It uses a vibrant color palette, celebrates a wide variety of Japanese subcultures of the time (such as [Gyaru](https://aesthetics.fandom.com/wiki/Gyaru "Gyaru")), and its community has a personal connection to the cultural context of that time.
* Juminocore is a **Western-coined internet aesthetic** that views Heisei-era objects through an external, nostalgic lens. It is more visually specific, with a more muted and curated color palette and a focus on "cute clutter" as a form of interior design. It is a Western interpretation, not a direct continuation, of the original Japanese subculture. The Reddit thread listed in "Resources" shows that many individuals see Juminocore as a separate, Western-influenced trend.
...
* San-X
  + Rilakkuma (2003)
* Sonny Angel (2004)
* Peanuts (featuring Snoopy) (1950)
* Pop Mart

### Manga & Anime

* My Neighbor Totoro (Studio Ghibli film, 1988)
* Kiki's Delivery Service (Studio Ghibli film, 1989)
* Yotsuba&! (Manga, 2003-present)

### Video Games

* Kirby series (1992-present)
* Toro Inoue series (1999-present)

## Resources

* ["what are the differences between Heisei Retro and Juminocore? ✨"](https://www.tiktok.com/@addyharajuku/video/7496597661794028822) (TikTok video by Addy)
* ["heisei retro is VERY different from juminocore"](https://www.reddit.com/r/heiseiretro/comments/1igqtj0/heisei_retro_is_very_different_from_juminocore/) (Reddit thread)
...
- `images/juminocore/Https---sk.pinterest.com-pin-13370130137752357-.png`
- `images/juminocore/Https---sk.pinterest.com-pin-17099673581026760-.jpg`
- `images/juminocore/Https---sk.pinterest.com-pin-611152611968660335-.png`
- `images/juminocore/Https---sk.pinterest.com-pin-7459155628021494-.png`
- `images/juminocore/Https---sk.pinterest.com-pin-33073378509098158-.png`
- `images/juminocore/2-https---sk.pinterest.com-pin-15199717489151915-.png`
- `images/juminocore/Chuu!!.jpg`
- `images/juminocore/Jellyfishumbrella.jpg`
- `images/juminocore/Juminocore11.png`
- `images/juminocore/Juminocore222.jpg`
- `images/juminocore/8418b03acaf027121221332918c67c8d.jpg`

## Source and attribution

Text adapted from "Juminocore" on the Aesthetics Wiki (https://aesthetics.fandom.com/wiki/Juminocore), licensed CC-BY-SA 4.0. Retrieved 2026-07-22. Images retain their individual licenses; see the local `credits.json`.
