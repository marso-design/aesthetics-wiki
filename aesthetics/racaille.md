...
This page requires improvement. Please help us by [expanding it](https://aesthetics.fandom.com/wiki/Racaille?action=edit). If you are unsure how to help, check the article guide [Format and Content](https://aesthetics.fandom.com/wiki/Format_and_Content "Format and Content").
...
**Reason for Warning:** This page documents a subculture associated with a severe classist pejorative (originally meaning "scum") used against working-class and marginalized youth in France. The stereotype is explicitly linked to themes of criminality, drug dealing, gangster behavior, and anti-social conduct. Viewer discretion is strongly advised.
...
* Smoking the hookah
* Flexing about money, expensive things or women
* Selling drugs
...
As mentionned before, Racailles usually listen to french rappers :
...
* Singapore: [Ah Beng](https://aesthetics.fandom.com/wiki/Ah_Beng "Ah Beng")
* Romania: [Bombardier](https://aesthetics.fandom.com/wiki/Bombardier "Bombardier")
* United Kingdom and Ireland: [Chav/Roadman](https://aesthetics.fandom.com/wiki/Chav "Chav")
* Spain: [Choni/Cani](https://aesthetics.fandom.com/wiki/Choni "Choni")
* Russia, Ukraine and Belarus: [Gopnik](https://aesthetics.fandom.com/wiki/Gopnik "Gopnik")
* Poland: [Dresiarz](https://aesthetics.fandom.com/wiki/Dresiarz "Dresiarz")
* Serbia: [Dizelaši](https://aesthetics.fandom.com/wiki/Dizela%C5%A1i "Dizelaši")
* Chile: [Flaite](https://aesthetics.fandom.com/wiki/Flaite "Flaite")

## Gallery

Here are some more modern Racailles as of 2021

If you've already been to France before, you prolly once saw boys dressed up like this.
