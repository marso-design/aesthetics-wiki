...
related_media: ["Da Lama ao Caos (album)", "Manguebit (documentary)"]
source_url: "https://aesthetics.fandom.com/wiki/Manguebeat"
...
"Caranguejo Elétrico" Monument - Rua da Aurora, Recife - Pernambuco
...
- `images/manguebeat/Manguebeat.png`
- `images/manguebeat/Mangroove.png`
- `images/manguebeat/Manifest.png`

## Source and attribution

Text adapted from "Manguebeat" on the Aesthetics Wiki (https://aesthetics.fandom.com/wiki/Manguebeat), licensed CC-BY-SA 4.0. Retrieved 2026-07-22. Images retain their individual licenses; see the local `credits.json`.
