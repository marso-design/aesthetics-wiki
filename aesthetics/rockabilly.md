...
- `images/rockabilly/RockabillyCouple.jpg`
- `images/rockabilly/Rockabilly.jpg`

## Source and attribution

Text adapted from "Rockabilly" on the Aesthetics Wiki (https://aesthetics.fandom.com/wiki/Rockabilly), licensed CC-BY-SA 4.0. Retrieved 2026-07-22. Images retain their individual licenses; see the local `credits.json`.
