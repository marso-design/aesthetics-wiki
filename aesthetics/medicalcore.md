...
_Also known as: Hospitalcore, Nursecore_

Needs Work 🛠️

This page requires improvement. Please help us by [expanding it](https://aesthetics.fandom.com/wiki/Medicalcore?action=edit). If you are unsure how to help, check the article guide [Format and Content](https://aesthetics.fandom.com/wiki/Format_and_Content "Format and Content").  
**Reason:** This page requires a comprehensive overhaul. It currently functions as a conceptual dump centered on the broad theme of 'sickness' rather than a specific aesthetic. Its visual identity is poorly defined and largely redundant to more established aesthetics like [Yami Kawaii](https://aesthetics.fandom.com/wiki/Yami_Kawaii "Yami Kawaii") and [Traumacore](https://aesthetics.fandom.com/wiki/Traumacore "Traumacore").
...
**Reason for Warning:** This aesthetic has the potential to deal with bodily fluids, needles and other medical related topics. If these sort of things trigger you, please leave this page.

**Medicalcore** utilizes medical-related paraphernalia and imagery. It functions as a coping mechanism, similar to [Traumacore](https://aesthetics.fandom.com/wiki/Traumacore "Traumacore"), without romanticizing, fetishizing, or glorifying illness or medical trauma.
...
* Hospital wards
* Medicine
* Blood/Light [gore](https://aesthetics.fandom.com/wiki/Gorecore "Gorecore"), either by itself or interacting with another element of the image
* Monitors
* Red Cross
* Pills
...
Medicalcore fashion can take on a variety of appearances; surgical masks, hospital scrubs, nitrite/latex gloves, hospital gowns, lab coats, bandages, medical bracelets, and various other medical gear (like stethoscopes, etc.), and are often in pastel colors. Band-Aids with Sanrio or other cutesy/[Kawaii](https://aesthetics.fandom.com/wiki/Kawaii "Kawaii") patterns are extremely popular. Some people choose to emulate the look of a sick patient with things like gas masks, eye patches, bruises (either self-inflicted or accidental), gauze and large bandages, and mobile IV bags. [Halloween](https://aesthetics.fandom.com/wiki/Halloween "Halloween")/cosplay medical related costumes may also be worn.
...
* Reaper Nurses (*Dark Deception*)
* Medic (*Team Fortress 2*)
* Bianca Abercrombie (*Clinic of Horrors*)
* Nurse Sonico (*Super Sonico*)
* Bubbleheaded Nurses (*Silent Hill 2*)
...
* *Novocaine* by GHOST and Creep-P
* *Hyperdontia* by GHOST and Creep-P
* *Hospital* by Gurldoll
* *Terrified* by Jazmin Bean
* *The Medical Anomaly* by R.I.P./Really Introverted Producer
* *Little Lamb* by Jazmin Bean
* *Please, Doctor!* by Chenomio
* The cure by Olivia Rodrigo

## Gallery

A cute hospital bed with a Hello Kitty print on it.

An edit of Mikan Tsumiki from *Danganronpa 2: Goodbye Despair*.
...
- `images/medicalcore/E08c3dbd2765dd30cbac4807cbcc1a6e.jpg`
- `images/medicalcore/A3=.jpeg`
- `images/medicalcore/83B7DDEC-0CF4-441A-9EB5-37D2FD3D9114.jpeg`
- `images/medicalcore/Medcore.jpg`
- `images/medicalcore/Hellohospital.jpg`
- `images/medicalcore/Pinksick.jpg`
- `images/medicalcore/Mikantsumiki.gif`
- `images/medicalcore/Syringe-needle-ampoules-pink-background-144256608.jpg`
- `images/medicalcore/Blue-liminal-hospital-hallway.jpg`

## Source and attribution

Text adapted from "Medicalcore" on the Aesthetics Wiki (https://aesthetics.fandom.com/wiki/Medicalcore), licensed CC-BY-SA 4.0. Retrieved 2026-07-22. Images retain their individual licenses; see the local `credits.json`.
