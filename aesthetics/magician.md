...
name: "Magician"
slug: "magician"
aka: ["Magiciancore", "Stage-Magician Core", "Magic-Showcore", "Illusionistcore"]
...
In this aesthetic the fashion is most commonly consists of tuxedos or flashy stage costumes, taking some cues from styles such as [Steampunk](https://aesthetics.fandom.com/wiki/Steampunk "Steampunk"), Victorian Fashion or [Ouji](https://aesthetics.fandom.com/wiki/Ouji "Ouji"). However it can also incorporate some esoteric/celestial elements as seen on [Wizardcore](https://aesthetics.fandom.com/wiki/Wizardcore "Wizardcore"), or it can instead have a more modern twist to it by adding some [Punk](https://aesthetics.fandom.com/wiki/Punk "Punk") or [Goth](https://aesthetics.fandom.com/wiki/Goth "Goth") elements to go for a more Criss Angel inspired look. While Magiciancore fashion tends to be more masculine styled, feminine coordinates can take inspiration from the lovely assistants seen during magic shows or borrow some [Witchcore](https://aesthetics.fandom.com/wiki/Witchcore "Witchcore") elements.
...
* Artful from Die of Death (Roblox)
...
art by OyasumiSumika

A Magician cake

a comic book cover featuring Zatanna, a character associated with the Magician aesthetic

Magicianc aesthetic fashion

ditto

Dark/horror based Magician aesthetic album cover
