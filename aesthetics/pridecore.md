...
key_motifs: ["Pride flags", "moodboards", "stimboards", "custom flag designs", "glitter", "sparkles", "character icons"]
key_colours: ["Colors of various LGBTQ+ pride flags"]
key_values: ["Pride", "self-expression", "identity", "community", "celebration", "validation"]
related_aesthetics: ["Glitter Graphics", "Scenecore", "Kidcore", "Lovecore", "Webcore"]
...
* [Posts tagged "Pridecore"](https://www.tumblr.com/search/pridecore/) (Tumblr)

## Gallery

Abrosexual/Abroromantic color palette by Dragonsandmeerkats

Aroace color palette by Dragonsandmeerkats

Pansexual [Glam Rock](https://aesthetics.fandom.com/wiki/Glam_Rock "Glam Rock") moodboard by palatteflags on Tumblr
