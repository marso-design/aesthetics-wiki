...
name: "Tecktonik"
slug: "tecktonik"
aka: ["TCK", "Electro Dance", "Milky Way"]
...
_Also known as: TCK, Electro Dance, Milky Way_
...
The culture rapidly spread from the Parisian club scene to a mainstream audience, primarily through online video platforms like YouTube, becoming a short-lived but intense international fad. The aesthetic is defined by its energetic and intricate dance style, which combines elements of [rave](https://aesthetics.fandom.com/wiki/Rave "Rave"), [hip-hop](https://aesthetics.fandom.com/wiki/Hip-hop "Hip-hop"), and voguing, and a distinctive fashion featuring tight-fitting clothing, [punk](https://aesthetics.fandom.com/wiki/Punk "Punk")-inspired hairstyles like mullets and mohawks, and bright, often neon, colors. The trend's decline was as swift as its rise, largely attributed to over-commercialization and its perception as a fleeting fad.

## History

Tecktonik emerged in Paris during the early 2000s, within a broader European context of popular electronic music and the popularity of [rave](https://aesthetics.fandom.com/wiki/Rave "Rave") culture. In 2002, Alexandre Barousdin and Cyril Blanc coined the term "Tecktonik," derived from the French "tectonique" (tectonic), and began organizing "Tecktonik Killer" events at the Métropolis nightclub in Rungis. These events, part of "Tecktonik Events," aimed to promote Dutch and Belgian musical genres like Jumpstyle and Hardstyle within France. The scene featured dance battles incorporating styles such as Melbourne Shuffle and breakdancing, alongside visual elements like colorful LED lights, fire effects, and boxing rings. Participants in the early scene were referred to as "Killers" (masculine) or "Killeuses" (feminine).
...
* Sunglasses
* Hairstyles with [Punk](https://aesthetics.fandom.com/wiki/Punk "Punk")-inspired crests and lots of gel
...
* "Alive" by Mondotek
* "Blink" by John Dahlback
* "I Know" by Dynamic Rockers
* "Je Vais Vite" by Lorie
* "Keep it Comin'" by D-Block & S-Te-Fan
* "Kick This One" by Jeckyll & Hyde
* "Now You're Gone" by Tecktonik
* "Like This" by DJ Dess
* "One Desire" by Jakarta
* "PLAY" by Lorie
* "Superstar" by Jakarta
* "The First" by Robix
* "We Don't Dance, We Are the Dance" by SMDB
...
The Métropolis nightclub

A LED light belt, one of Tecktonik's most distinctive characteristics

Cover art for "Alive" by Mondotek

JAKARTA - ONE DESIRE 2019

An unofficial 2019 remake of the original music video by Jakarta Team.
...
| --- | --- | --- |
| Core Aesthetics |
| [Rave](https://aesthetics.fandom.com/wiki/Rave "Rave") ☺ [Acid House](https://aesthetics.fandom.com/wiki/Acid_House "Acid House") ☺ [Gabber](https://aesthetics.fandom.com/wiki/Gabber "Gabber") ☺ [Kandi Raver](https://aesthetics.fandom.com/wiki/Kandi_Raver "Kandi Raver") ☺ [Berlin Techno Fashion](https://aesthetics.fandom.com/wiki/Berlin_Techno_Fashion "Berlin Techno Fashion") ☺ [Bakala](https://aesthetics.fandom.com/wiki/Bakala "Bakala") ☺ [Krocha](https://aesthetics.fandom.com/wiki/Krocha "Krocha") ☺ [Madchester](https://aesthetics.fandom.com/wiki/Madchester "Madchester") ☺ [New Beat](https://aesthetics.fandom.com/wiki/New_Beat "New Beat") ☺ [Pokero](https://aesthetics.fandom.com/wiki/Pokero "Pokero") ☺ **Tecktonik** ☺ [UK Garage](https://aesthetics.fandom.com/wiki/UK_Garage "UK Garage") ☺ [Wixa](https://aesthetics.fandom.com/wiki/Wixa "Wixa") |
| Fusion Aesthetics |
...
- `images/tecktonik/Tecktonik.jpg`
- `images/tecktonik/Tecktonik8.png`
- `images/tecktonik/Tecktonik1.jpg`
- `images/tecktonik/Tecktonik3.png`
- `images/tecktonik/Tecktonik2.jpg`
- `images/tecktonik/Tecktonik5.png`
- `images/tecktonik/Tecktonik6.png`
- `images/tecktonik/Tecktonik4.png`
- `images/tecktonik/Tecktonik7.png`
- `images/tecktonik/Tecktonik11.png`
- `images/tecktonik/Tecktonik12.png`
- `images/tecktonik/Tecktonik9.gif`
- `images/tecktonik/Tecktonik10.png`
- `images/tecktonik/Ledlight.png`
- `images/tecktonik/Tecktonik13.jpg`
- `images/tecktonik/Teckmeup1.jpg`
- `images/tecktonik/Teckmeup2.jpeg`
- `images/tecktonik/Tecktotik.png`
- `images/tecktonik/Tecktonikdance.gif`

## Source and attribution

Text adapted from "Tecktonik" on the Aesthetics Wiki (https://aesthetics.fandom.com/wiki/Tecktonik), licensed CC-BY-SA 4.0. Retrieved 2026-07-22. Images retain their individual licenses; see the local `credits.json`.
