...
source_url: "https://aesthetics.fandom.com/wiki/Wizardcore"
...
This page requires improvement. Please help us by [expanding it](https://aesthetics.fandom.com/wiki/Wizardcore?action=edit). If you are unsure how to help, check the article guide [Format and Content](https://aesthetics.fandom.com/wiki/Format_and_Content "Format and Content").

**Wizardcore** is an aesthetic based off of magic, [fantasy](https://aesthetics.fandom.com/wiki/Fantasy "Fantasy"), and the taste for discovery and [exploration](https://aesthetics.fandom.com/wiki/Adventurecore "Adventurecore"). It's similar to [Witchcore](https://aesthetics.fandom.com/wiki/Witchcore "Witchcore"), with the same theme of magic, but is generally the more masculine counterpart. It is also related to the [Academia](https://aesthetics.fandom.com/wiki/Academia "Academia") aesthetics, with the need for knowledge and experimentation, whether it be of interests or projects.
...
In the 20th century, wizards began to be associated with the fantasy genre of fiction. Wizards were often seen as the antagonists in a genre of [Pulp Magazines](https://aesthetics.fandom.com/wiki/Pin-up#Pulp_Magazines "Pin-up") called **Sword and Sorcery**. This continued into the boom of fantasy fiction from the [1960s](https://aesthetics.fandom.com/wiki/1960s "1960s") to the [1980s](https://aesthetics.fandom.com/wiki/1980s "1980s"), largely based on the popularization of *The Lord of the Rings* by J. R. R. Tolkien. These depictions of wizards often featured them with large cloaks and pointed hats surrounded by magic and energy, which is related to the "Wizardposting" meme.

In the [1990s](https://aesthetics.fandom.com/wiki/1990s "1990s"), the depictions of wizards started to change to be toned down and less archetypical. For example, the *Harry Potter* series depicted wizards as ordinary people.

## Visuals

Visuals that are part of Wizardcore but not limited to:
...
* Old/[Victorian](https://aesthetics.fandom.com/wiki/Victorian "Victorian") mirrors
* Succulents
* Gems and stones
* Brooches
* Scrolls
...
* Hanging out with your familiar (animal companion)
* Studying spells
...
* [Alex Russo](https://wizardsofwaverlyplace.fandom.com/wiki/Alex_Russo) (*Wizards Of Waverly Place*)
* [Zatanna](https://dc.fandom.com/wiki/Zatanna_Zatara_(New_Earth)) (DC Universe)
* [Ice King](https://adventuretime.fandom.com/wiki/Ice_King) (*Adventure Time*)
* [Forest Wizard](https://adventuretime.fandom.com/wiki/Forest_Wizard) (*Adventure Time*)
* [Kyle](https://fanboychum.fandom.com/wiki/Kyle) (*Fanboy and ChumChum*)
* [Bufo](https://adventuretime.fandom.com/wiki/Bufo) (*Adventure Time*)
* Harry Potter (*Harry Potter* franchise)
* Ron Weasley (*Harry Potter* franchise)
* Doctor Strange (Marvel Cinematic Universe)
* [Max Russo](https://wizardsofwaverlyplace.fandom.com/wiki/Max_Russo) (*Wizards Of Waverly Place*)
* [Haruto Sohma](https://kamenrider.fandom.com/wiki/Haruto_Soma) (*Kamen Rider Wizard*)
* [Bufo](https://adventuretime.fandom.com/wiki/Bufo) (*Adventure Time*)
* [Majisto](https://brickipedia.fandom.com/wiki/Majisto) (*Lego*/*Lego Dragon Masters*)
* Rincewind (*Discworld*)
...
* Ziggy (*Brawl Stars*)
* Shaman (*ENA: Dream BBQ*)
* Harry Dresden (*The Dresden Files*)
* Cedric the Sorcerer (*Sofia the First*)
* Miriel (*Fire Emblem*)
* Marcia Overstrand (*Septimius* Heap)
...
- `images/wizardcore/Wizardcore1.jpg`
- `images/wizardcore/Wizardcore2.jpg`
- `images/wizardcore/Wizardcore3.jpg`
- `images/wizardcore/Wizardcore4.jpg`
- `images/wizardcore/Wizardcore5.jpg`
- `images/wizardcore/Wizardcore6.jpg`
- `images/wizardcore/Wizardcore8.jpg`
- `images/wizardcore/Wizardcore7.jpg`
- `images/wizardcore/Wizardposting2.jpg`
- `images/wizardcore/Jars.jpg`
- `images/wizardcore/BlueCards.jpg`
- `images/wizardcore/Collectables.jpg`
- `images/wizardcore/Dices.jpg`
- `images/wizardcore/Dragon.jpg`

## Source and attribution

Text adapted from "Wizardcore" on the Aesthetics Wiki (https://aesthetics.fandom.com/wiki/Wizardcore), licensed CC-BY-SA 4.0. Retrieved 2026-07-22. Images retain their individual licenses; see the local `credits.json`.
