...
source_url: "https://aesthetics.fandom.com/wiki/Angura_Kei"
...
In the 1990s and 2000s, several alternative bands in the [Visual Kei](https://aesthetics.fandom.com/wiki/Visual_Kei "Visual Kei") scene intentionally gravitated toward the Angura aesthetic and sound, often incorporating the theatrical and political elements into their performances. Groups like Guruguru Eigakan (Spinning Cinema), Inugami Circus Dan (Circus Troupe of the Dog God), and Strawberry Song Orchestra are noted for wearing *shironuri* makeup, retro clothing, and incorporating the soundscapes of Angura theatre composer J.A. Seazer into their music. These groups often host genre-bending concerts and collaborative theater-concerts.
...
* [Matching Mole](https://matchingmole.shopselect.net/)
...
- `images/angura-kei/1496690205945.jpg`
- `images/angura-kei/1496691687147.jpg`
- `images/angura-kei/18526-jp3cd5uqw9.jpg`
- `images/angura-kei/Kizu-oshimai-750x400.jpg`
- `images/angura-kei/Kizu-human-error-artist-photo-750x400.jpg`

## Source and attribution

Text adapted from "Angura Kei" on the Aesthetics Wiki (https://aesthetics.fandom.com/wiki/Angura_Kei), licensed CC-BY-SA 4.0. Retrieved 2026-07-22. Images retain their individual licenses; see the local `credits.json`.
