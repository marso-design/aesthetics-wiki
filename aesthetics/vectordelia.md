...
name: "Vectordelia"
slug: "vectordelia"
aka: ["Frutiger Metro", "Abstract Vector Art", "Vector Maximalism"]
...
_Also known as: Frutiger Metro, Abstract Vector Art, Vector Maximalism_

**Vectordelia**, popularly known as **Frutiger Metro** online, is a graphic design aesthetic that was prevalent from the mid-2000s to early 2010s. The style represents a peak of "humanist maximalism" in computer-aided graphic design, characterized by the vibrant and sometimes glossy use of vector graphics.

Visually, it features abstract flourishes, fluid shapes, solid silhouettes, and gradient blocks, often set against a monochrome background. Unlike the skeuomorphic realism of [Frutiger Aero](https://aesthetics.fandom.com/wiki/Frutiger_Aero "Frutiger Aero"), Vectordelia focuses on flatter but more elaborate non-photorealistic forms with crisp, geometrically neat outlines. In animated contexts (such as the iconic iPod commercials or Xbox 360 dashboards) designs typically flow outwards from a central point, gaining variety and complexity as they grow.

## History

### Origins & Naming

**Terminology Note:** This aesthetic is historically referred to as generic names like "vector art." The term "Frutiger Metro" was coined on this wiki in 2023 and became the de facto name on social media. However, it is technically a misnomer, as the style predates the flat [Metro design language](https://en.wikipedia.org/wiki/Metro_(design_language) "wikipedia:Metro (design language)") (Windows 8) and is visually distinct from the [Frutiger Family](https://aesthetics.fandom.com/wiki/Frutiger_Family "Frutiger Family"). The page has been renamed to correct this historical error while preserving the popular term as an alias.
...
The aesthetic's decline in the early to mid-2010s coincided with a broader shift away from [maximalist](https://aesthetics.fandom.com/wiki/Maximalist "Maximalist") designs towards flatter, more [minimalist](https://aesthetics.fandom.com/wiki/Minimalist "Minimalist") aesthetics. This transition was evident in the move from Windows 7's Aero interface to Windows 8's Metro UI and the shift in mobile operating systems like iOS 7 towards simplified, less cluttered designs. Companies began to perceive the colorful, maximalist designs as less practical and more ornamental, prioritizing efficiency and functionality. While some arguments suggested that the abstract nature of the aesthetic detracted from usability, others maintained that its vibrant backgrounds and gradients enhanced user engagement, particularly in gaming.
...
**Vectorfunk** (formerly **Funky Metro**) is one of the most common sub-aesthetics of Vectordelia. Music and partying are the most defining themes of this sub-aesthetic, musical instruments, speakers, DJs, headphones, microphones, and human silhouettes being prominent characteristics. It also shares a lot of similarities and overlap with [Superflat Pop](https://aesthetics.fandom.com/wiki/Superflat_Pop "Superflat Pop") and [Four Colors](https://aesthetics.fandom.com/wiki/Four_Colors "Four Colors") with the use of vivid and vibrant colors, primarily targeted toward teenage and young adult demographics.

iPod Shuffle Commercial (2005)

iPod wallpaper, 2008

Xbox 360 Arcade

サイハテ ("Saihate") by Onyx Kobayashi (2009)

'Blogy Rosa' Blogger Template (2008)

a Frutiger Metro edit by vomitgloomzr on Deviantart (2024)

### Vectorgarden

**Vectorgarden** is a subgenre characterized by minimalist abstract flourish, feminine patterns, flowers, auroras, butterflies, bubbles, as well by the heavy use of gradients, transparent, and glossy textures. Vectorgarden was popular between the Mid-[2000s](https://aesthetics.fandom.com/wiki/Category:2000s "Category:2000s") and Mid-[2010s](https://aesthetics.fandom.com/wiki/Category:2010s "Category:2010s"), sharing a lot of overlap with Frutiger Aero since they share many of their visual motifs such as humanism, nature, [auroras](https://aesthetics.fandom.com/wiki/Frutiger_Aurora "Frutiger Aurora"), and glossy textures. Vectordelia embodies many of these motifs and also shares one of Vectorgarden's core characteristics of being used in an exclusively flat, maximalist style.

Easy Bake oven

iDog

Disney cover for Asus laptop

Littlest Pet Shop

Barbie Handheld Learning Game
...
a screenshot of the opening of Monster High (2010), featuring Clawdeen Wolf

Art by HarshNoiseMT

### Vector Grunge

**Vector Grunge** (formerly **Grungy Metro**) focuses on the grungy elements of Vectordelia, which are often associated with the [Emo](https://aesthetics.fandom.com/wiki/Emo "Emo"), [Scene](https://aesthetics.fandom.com/wiki/Scene "Scene"), and [UrBling](https://aesthetics.fandom.com/wiki/UrBling "UrBling") aesthetics. Splats, overlapping vector patterns, and the heavy use of the color [black](https://aesthetics.fandom.com/wiki/Category:Black "Category:Black") are the main visual motifs seen in this style.

<https://www.deviantart.com/miranxxx/art/Wallpaper-star-83010030>

Cartoon Network logo

Art by: Belly on DeviantArt

### Vector Música

➔ Main article: [Vector Música](https://aesthetics.fandom.com/wiki/Vector_M%C3%BAsica "Vector Música")
...
Just Dance 4 Call Me Maybe

Just Dance 4 (Call Me Maybe)

Wall illustration at the Espacio Coruña mall in A Coruña, Galicia, Spain

Pokemon Best Wishes ~ Mitte Mitte ☆ Kochichi Full Dance

Violetta - Theme Song - Official Disney Channel UK
...
* Pink or Black by kz (livetune) feat. Hatsune Miku
* Po Pi Po by Lamaze-P feat. Hatsune Miku
* Psycho Teddy by Jamster
* Summer Eletrohits Vol. 1-8
* Rainbow Tylenol by Kitsune^2
* Skuggin' Around by Kitsune^2
* Sleepyhead by Passion Pit
* This Too Shall Pass by OK GO
* Triple Baka by Lamaze-P feat. Hatsune Miku
* Tadhana by Moonstar88
* U Weren't Here I Really Miss You by Cult Member
...
* The Numtums Season 1 (2012)
* Monster High (2010-2016)
* More than a Game (2008) (Poster only)
...
* Bleach (2004-2012, 15th opening only)
...
* Harumika.com
* Lumines I & II (2004-2006)
* ModNation Racers (2010) (Title logo and opening menu only)
...
* Zubo (2008) (Promotional materials only)
...
* Barbiegirls.com MP3 players (2007-2010)
* Various electronic diaries
...
* Beatriz Milhazes
* Cody Vondell
* HarshnoiseMT (Megan Trushell) on Reddit
* Shiorisketch on Instagram (specific works)
* Joanna Davidovich on YouTube, Instagram, Twitter, Twitch, et al.
...
* Barbie lines including Fashion Fever, Thumbelina, Early Fashionistas, Mini B/Peekaboo Petites, Barbie Tech, ect.
* MyMeebas
* Pop Soft Plush
* Harumika
...
Art by Joanna Davidovich (JoTheZette)

Hasbro i-Turtle (circa 2009)

de BLOB 2 (2011)

The Fresh Beat Band (2009-2013)

LPS Postcard Pets collection

Belanova - Fantasía Pop (2007)

by LollipopBFDI167 on DeviantArt; B.F.B. fan art based off of Vectordelia.

Windows 7 Wallpaper by Adhemas Batista

Malhação - 14th Season (2007)

Hetalia, an anime created by Himaruya Hidekaz that was most popular around 2008-2015

Promotional art for the Xbox 360 (2005)

Novi Stars

Moxie Girlz

A Vectordelia image with dark colors

MNCTV (Indonesia) Station ID, circa 2010

Not Just Cartoons: Nicktoons! (2007)

Idexè card

2009 Prototype CN Check it ident

TiVo Roamio instruction booklet

A Nickelodeon bumper from 2005

Album cover of Gabry2o Vol. II by Gabry Ponte (2009)

Album cover of Mihimalife by Mihimaru (2005)

The cover artwork for LittleBigPlanet 3 (2014)

A photo titled "jae" by julianakrewer on Flickr (2008)

"Cake at Stake" Intro from "Battle for Dream Island: The Power of Two: Transitional Shift" (2025)

Biz Kid$ (2008-2017)

A Vectordelia/Digital Grunge VectorKit background created by @CodyVondell on Twitter.
...
Cox Internet Commercial 2004 (Frutiger Metro Style)

Static Revenger & Richard Vission ft. LUCIANA 'I Like That'

ROMANCEPLANET - FALL FROM THE SKY (OFFICIAL MUSIC VIDEO)

IPod shuffle

Let's Explore Hyper Specific 2000s Aesthetics

ABS-CBN - 'Beyond Television' - Station Ident (2008)

Testing-2

Eurovision 2009 - The Postcards

Girls' Generation 소녀시대 '비주얼 드림 (POP! POP!) MV
