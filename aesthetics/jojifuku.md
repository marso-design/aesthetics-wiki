...
name: "Jojifuku"
slug: "jojifuku"
aka: ["Shoujo fashion", "Heisei Joshi"]
...
_Also known as: Shoujo fashion, Heisei Joshi_
...
**Reason for Warning:** This page documents an aesthetic centered on motifs of childhood. The content discusses major controversies associated with the style, including its association with sexual age play and fetish content (as its hashtags are used for NSFW imagery and adult video promotion) and its link to eating disorder behaviors due to the emphasis on achieving a body size that fits children's clothing to promote extreme thinness. Viewer discretion is strongly advised.

**Jojifuku** (女児服), which translates to "girl's clothing," is a Japanese fashion style centered on adults wearing clothing and accessories that evoke a sense of nostalgic Japanese childhood from 1989 to the 2000s. The style draws heavily from the a period when children's brands featured in Shoujo magazines like Nakayoshi and Ciao gained significant popularity. The style is often compared to Fairy Kei and Nanchatte Seifuku for its use of childish motifs and themes. The male equivalent of the style, based on clothing from boys' magazines, is called **Danjifuku** (男児服).
...
Jojifuku fashion is characterized by its use of children's clothing brands and motifs from Japan's [Y2K](https://aesthetics.fandom.com/wiki/Y2K "Y2K") era, prioritizing a cute and nostalgic look. The aesthetic is distinct from other styles in its focus on specific Japanese children's brands and its more contained color palette.

The style features clothing from nostalgic brands, most notably those from [Narumiya Inc](https://en.wikipedia.org/wiki/Narumiya_International "wikipedia:Narumiya International")., such as Mezzo Piano, Angel Blue, and Pom Ponette.

### Tops

Common pieces include slim fit or classic fit tees, tank tops, long sleeves, sweatshirts with playful prints, which would appeal to children and their parents for ease of wearability and washing. The vinyl prints are different configurations of the brands' mascots, cute English phrases, sweets and fruit, toys, etc. Often, these are raglan or ringer tees, providing even more colors and visual interest.
...
* *[#大人なのに女児服着てる! その1](https://kerastyle.jp/fashion/687)*
* *[#大人なのに女児服着てる! その2](https://kerastyle.jp/fashion/705)*
* *[Ciao](https://en.wikipedia.org/wiki/Ciao_(magazine) "wikipedia:Ciao (magazine)")*
* *[Nakayoshi](https://en.wikipedia.org/wiki/Nakayoshi "wikipedia:Nakayoshi")*
* *[Nicola](https://en.wikipedia.org/wiki/Nicola_(magazine) "wikipedia:Nicola (magazine)")*
* *[Pichi Lemon](https://en.wikipedia.org/wiki/Pichi_Lemon "wikipedia:Pichi Lemon")*
* *[Pucchigumi](https://en.wikipedia.org/wiki/Pucchigumi "wikipedia:Pucchigumi")*
* *[Ribon](https://en.wikipedia.org/wiki/Ribon "wikipedia:Ribon")*
* *[Sho-Comi](https://en.wikipedia.org/wiki/Sho-Comi "wikipedia:Sho-Comi")*

## Resources

### Blogs

* [Sorasido Girls' Culture](https://www.instagram.com/sorasido_girlsculture/)

### Vendors

* [Angelic Pretty](https://angelicpretty.com/)
* [Angel Blue](https://www.instagram.com/angelblue_official/)
* [Betty's Blue](https://www.canshop.jp/bettys/)
* Bruyant
* [CandyChuu](https://www.candychuu.com/)
* [CRT Cutie](https://www.instagram.com/crt_cutie_official)
* Cute Paradise
* Cutie Yummy
* [Daisy Lovers](https://www.instagram.com/daisylovers_official/)
* [Earth Magic](https://www.earthmagicwebstore.jp/)
* K.L.C.
* Liz Lisa Doll
* [Mezzo Piano](https://www.narumiya-online.jp/shop/brand/20/)
* [Miki House](https://www.mikihouse.co.jp/)
* MINI-K
* [Mother Garden](https://shop.creativeyoko.co.jp/shop/mothergarden)
* Orange Bon Bon
* [Pom Ponette](https://www.narumiya-global.com/en/shop-by-brands/pom-ponette-junior/)
* Sannennikumi (3nen2kumi)
* [Sanrio](https://www.sanrio.com/)
* San-X
* Tamagotchi
* [To Alice](https://www.toalice.co.jp/)
* Tralala

## Gallery

Kera magazine feature on Jojifuku

Typical fashion feature in a shoujo magazine during the 2000s.
