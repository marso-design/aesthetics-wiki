...
_Also known as: Gabba, Gabbercultuur_
...
**Reason for Warning:** This page documents a subculture whose history is linked to extensive illicit drug use and high-risk environments (including police raids and illegal parties). The content explicitly discusses the subculture's historical association with racism, neo-Nazism, and right-wing extremist beliefs linked to certain fashion choices. This content is presented for documentation only and does not endorse or promote harmful behaviors. Viewer discretion is strongly advised.
...
The popularity of Gabber faded away by the 2000s, although the scene still exists and its focus has shifted primarily to the music and keeping a positive atmosphere at Hardcore events. The influence of Gabber also resurged in an unexpected place: Poland, where the movement is locally called [Wixa](https://aesthetics.fandom.com/wiki/Wixa "Wixa") (or Viksa/Vixa).
...
* **Amigacore** is a niche form of tracker music. It is characterized by its [8-bit](https://aesthetics.fandom.com/wiki/8-Bit "8-Bit") sound, a result of being produced on first-generation Amiga computers with limited sound capabilities. Amigacore tracks often feature a raw, crunchy, and minimalistic aesthetic, with repetitive and aggressive compositions. Due to the Amiga's sound chip limitations, most Amigacore recordings are in mono or pseudo-stereo.
* **Artcore** (not to be confused with [Japanese Artcore](https://aesthetics.fandom.com/wiki/Artcore "Artcore")) is a subgenre of Gabber that was pioneered by Ruffneck Records, founded by DJ Ruffneck, and later Gangsta Audiovisuals. It is characterized by the incorporation of breakbeats into the hardcore sound. This style combined breakbeats with "tearing" Juno synths and heavily distorted kick drums. However, it is not a widely used term.
* **Gabberpop** (also stylized as **Gabber-Pop** or **Pop-Gabber**) is a musical genre that combines elements of pop music with gabber and related genres such as happy hardcore. It typically features strong kick drums combined with pop or rap vocals, with tempos usually ranging from 150 to 180 BPM.
...
* **Terrorcore** is a extreme subgenre of Gabber that developed as a darker counterpart to happy hardcore. With tempos ranging from 160 to 300 BPM, it is characterized by its aggressive sound, incorporating samples from [horror](https://aesthetics.fandom.com/wiki/Horror "Horror") movies and [metal](https://aesthetics.fandom.com/wiki/Metal "Metal") music. Terrorcore retains the distorted kicks of Gabber but adds layers of distortion and other harsh sounds for an even more extreme sound.
...
* [Alles Naar de Klote](https://www.youtube.com/watch?v=yE32aoIDjvY) by Euromasters
* [Army of Hardcore](https://www.youtube.com/watch?v=-RSncqzAkJw) by Neophyte vs Stunned Guys
* [Buurman Uit Berlijn](https://www.youtube.com/watch?v=lN-e8qy5u4g) by MCR-T & Joost
* [Cuntface](https://www.youtube.com/watch?v=AGaEHspMbc4) by Nasenbluten
* [Earthquake](https://www.youtube.com/watch?v=lZeJjYBmpV8) by Art of Fighters
* Europapa by Joost
* [Mossels](https://www.youtube.com/watch?v=1SwlqFc8RHA) by Mosselman
* [Name of the DJ](https://www.youtube.com/watch?v=2oUI6qRk_6k) by Chosen Few
* [On The Edge](https://www.youtube.com/watch?v=tuWDN7w2eJc) by The Playah
* [Skull Dominion](https://www.youtube.com/watch?v=1Zte_5h0FDk) by Rotterdam Terror Corps & Paul Elstak
* [Wachtmuziek](https://www.youtube.com/watch?v=_nxkvJYi4BI) by Joost

## Resources

* [Iskhur's Guide to Electronic Music](https://music.ishkur.com/)
* [Gabber](https://rateyourmusic.com/genre/gabber/) on Rate Your Music
* [Gabber](https://everynoise.com/engenremap-gabber.html) on Every Noise at Once
* [Nu-Gabber](https://everynoise.com/engenremap-nugabber.html) on Every Noise at Once
* [90's Gabber Flyers](https://x.com/gabberflyers) on Twitter (X)
