...
**Larme Kei** (ラルム系) is a style described by the *overseas* community centered around the early issues of the Japanese fashion magazine LARME that features a dainty feminine aesthetic catered towards women in their 20s. The term itself is not used in Japan, and the core style of the magazine is known as "[Girly fashion](https://aesthetics.fandom.com/wiki/Girly_(Japanese) "Girly (Japanese)")" (ガーリーファッション) or "[Girly Kei](https://aesthetics.fandom.com/wiki/Girly_(Japanese) "Girly (Japanese)")" (ガーリー系).
...
The aesthetic later faded in popularity in the overseas community, and many of the Blogspots ceased to post or had their domains taken down. The tag is still in use, and like many J-fashion communities, has new content on TikTok. However, the TikTok outfits incorporate elements of [Jirai](https://aesthetics.fandom.com/wiki/Jirai_Kei "Jirai Kei"), which is another departure from the original wearability featured in the Larme magazine.

This aesthetic has also led to [Jirai Kei](https://aesthetics.fandom.com/wiki/Jirai_Kei "Jirai Kei"). Since both originate from girly aesthetics, there are many commonalities, especially with the pink and black color combination being extremely popular. Many of the brands that produced clothing featured in Larme magazine had made their designs resemble Jirai styles in the 2020s. Because of this, many western people also misattribute Jirai Kei as Larme.
...
Larme Kei styles largely focus on hyper-femininity, with **different outfits balancing or leaning towards [elegant](https://aesthetics.fandom.com/wiki/Elegant "Elegant"), sexy, or girlish elements.** Many bloggers have mentioned this in styling, with making a garment contrast the other to make the look more "Larme" as opposed to purely girlish or purely sexy. For example, a puffed sleeve pink blouse (girlish) pairs with a black pencil skirt (mature), while a black cold-shoulder top (sexy) pairs with a fluffy tulle skirt (girlish). In the magazine, these elements are also often kept separate, as different sections of the issue have different themes.
...
The original spread coining the term (020)

continued from first image

An outfit labeled "pheromone fetish" from an Australian blog (petitedollies)

### American & French Lolita

The earliest issues of Larme magazine had a high focus on "Lolita fashion", much to the annoyance of Japanese [Lolita fashion](https://aesthetics.fandom.com/wiki/Lolita "Lolita") enthusiasts. In the case of Larme, the term Lolita is used as name for [nymphet fashion](https://aesthetics.fandom.com/wiki/Nymphet "Nymphet") with "American Lolita" being inspired by the 1997 movie and "French Lolita" by the works of Serge Gainsbourg. Thus, the fashion spreads the editors made were in the style of the different film adaptations. **Red, especially gingham**, was a common motif. **Cherries, sailor collars, and other fashion motifs found in the film adaptations** were the common traits of this substyle.

### Grunge

Often, the magazine draws upon inspiration from [grunge](https://aesthetics.fandom.com/wiki/Grunge "Grunge") fashion, with individual spreads focusing on the re-interpretation of the aesthetic. Here, the editors and fans combine garments typically associated with grunge with the magazine's style. The outfits here are also in **darker colors,** avoid girlish styles, and use **stiffer fabrics and metal embellishments.**

Common garments here include: **bomber/military jackets, platform boots, and tee shirts**.

Larme 020

continued from the first image
...
Defunct blogs will include a link to a Wayback Machine archive.

### Tumblr Blogs

* [Larme](https://larme-kei.tumblr.com/)
* [Larme Looks](https://larme-looks.tumblr.com/)
* [Larme Magazine](https://larme-magazine.tumblr.com/)

### Blogs

* [Universal-Doll (Defunct)](https://web.archive.org/web/20150308211817/https://universal-doll.com/2014/08/larme-magazine-introduction/)
* [Petite Dollies (Defunct)](https://web.archive.org/web/20240000000000*/https://petitedollies.com/)
* [Heartbreak Cherry (Defunct)](https://web.archive.org/web/20240000000000*/https://heartbreakcherry.blogspot.com/)

## Gallery

In Japan, this look is called "Girly fashion" or "Girly Kei"

Anatomy of a Larme Girl

E Hyphen World Gallery BonBon employee

xoxosaramari on tumblr

sweetpasteldream on polyvore

Katie the store promo pictures

Larme kei Makeup Tutorial by Risa Nakamura

🌹🎀 Larme Style Guide 🎀🌹

Art by snow-priestess
