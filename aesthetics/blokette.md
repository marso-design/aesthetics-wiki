...
key_motifs: ["Football shirts", "athletic sweaters and jackets", "pleated wool skirts", "ballet flats", "leg warmers", "hair ribbons", "Adidas Sambas"]
key_colours: ["Team colors (e.g., white, navy, red, yellow)", "pastels (from Coquette influence)"]
key_values: ["Combining masculine and feminine elements", "playful gender expression", "visual contrast"]
related_aesthetics: ["Balletcore", "Blokecore", "Coquette", "Tenniscore", "Ultras", "Waif"]
...
This page requires improvement. Please help us by [expanding it](https://aesthetics.fandom.com/wiki/Blokette?action=edit). If you are unsure how to help, check the article guide [Format and Content](https://aesthetics.fandom.com/wiki/Format_and_Content "Format and Content").

**Blokette**, a [microtrend](https://aesthetics.fandom.com/wiki/Microtrend "Microtrend") popularized on TikTok, was coined by the fashion commentary podcast Nymphet Alumni in late 2022. This aesthetic blends elements of [Blokecore](https://aesthetics.fandom.com/wiki/Blokecore "Blokecore") and [Coquette](https://aesthetics.fandom.com/wiki/Coquette "Coquette") styles. Blokecore involves masculine-leaning pieces such as oversized football jerseys, vintage sports jackets, and Adidas Sambas, drawing from a simplified interpretation of English pub and sports culture. In contrast, the Coquette aesthetic is hyper-feminine, focusing on elements like mini skirts, knee-high socks, and hair ribbons.
