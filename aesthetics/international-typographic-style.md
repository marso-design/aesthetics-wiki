...
aka: ["ITS", "Swiss Style", "Schweizer Typografie (German)"]
...
_Also known as: ITS, Swiss Style, Schweizer Typografie (German)_

The **International Typographic Style** is a graphic design style that emerged in Switzerland and Germany during the 1930s-1950s and gained international prominence in the 1960s. It developed alongside other similar [modernist](https://aesthetics.fandom.com/wiki/Modernism "Modernism") movements, such as Russian [Constructivism](https://aesthetics.fandom.com/wiki/Constructivism "Constructivism"), Dutch [De Stijl](https://aesthetics.fandom.com/wiki/De_Stijl "De Stijl"), and the German [Bauhaus School](https://aesthetics.fandom.com/wiki/Bauhaus "Bauhaus"), as a reaction to the perceived excess of previous graphic design trends at the time. It is characterized by its functionality, typography, simplicity, cleanliness, readability, and objectivity. It was pioneered by Jan Tschichold, Josef Müller-Brockmann and Armin Hofmann, further influenced by Max Miedinger and his colleagues, Armin Hofmann and Emil Ruder.
...
The sans-serif fonts are still the most widely used ones in New Wave Typography, but it differences itself from the Swiss Style by ditching the widely used grid structure, using unconventional and bold elements, and incorporating influence from the [punk](https://aesthetics.fandom.com/wiki/Punk "Punk") subculture, [psychedelia](https://aesthetics.fandom.com/wiki/Psychedelia "Psychedelia"), and post-modernism. Although the movement was anti-corporate at heart, the similarities with the International Typographic Style were still very present, leading some to deem it a "softer, more commercialized version of punk culture".

Painting by Wolfgang Weingart (1941).

Poster by Dan Friedman (1971).

Citibank logo by Dan Friedman, which he self-described as "Radical Modernism".

By Dan Friedman.

## Figures

* Adrian Frutiger (see also [Frutiger Aero](https://aesthetics.fandom.com/wiki/Frutiger_Aero "Frutiger Aero"), named after his "Frutiger" font)
* Anton Stankowski
* Armin Hofmann
* Bob Noorda
* Bruno Pfäffli
...
Offset lithograph poster for Der Film by Josef Müller-Brockmann (1960)

Poster by Iannis Svoronos, 1963, ink on paper

Poster for the Gewerbemuseum Basel (1959)

Swiss Style poster (1969)

Swiss Style poster (1959)

Exhibition poster designed by Armin Hofmann for the Gewerbemuseum Winterthur ([Arts and Crafts](https://aesthetics.fandom.com/wiki/Arts_and_Crafts_Movement "Arts and Crafts Movement") museum) (1951)

Poster designed by Armin Hoffman for an exhibition of artworks by Mark Rothko and Eduardo Chillida, at Kunsthalle Basel. (1962)

Poster for a Konkretist Klub exhibition in Jihlava, by Jiří Hilmar (1968).

Advertising mockup for Siam, by Juan Carlos Distéfano, 1962, ink on paper

Book cover design for The Hidden Persuaders, by Larry Carter, 1962, ink on paper

Poster by Josef Müller-Brockmann (1957)

Poster for the 1976 Summer Olympics in Montreal, Canada.

Josef Müller-Brockmann's grid system (1981)
