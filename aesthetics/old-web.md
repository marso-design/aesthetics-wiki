...
name: "Old Web"
slug: "old-web"
aka: ["Web 1.0 Aesthetic", "GeoCities Aesthetic", "1990s Web Design"]
...
_Also known as: Web 1.0 Aesthetic, GeoCities Aesthetic, 1990s Web Design_
...
The Old Web era is remembered nostalgically for its perceived freedom, unfiltered creativity, and decentralized, community-driven nature. This historical period and its distinct visual language serve as the primary source of inspiration for the modern [Webcore](https://aesthetics.fandom.com/wiki/Webcore "Webcore") aesthetic, which reinterprets these elements through a contemporary and surrealist lens.

## Visuals

1990s web design was defined by a number of iconic visual elements. Animated GIFs were ubiquitous, used for everything from spinning email icons and dancing baby memes to simple page dividers and "under construction" banners. Graphics were often low-resolution, featuring pixel art, heavily compressed JPEGs, and readily available clip art. The use of [glitter graphics](https://aesthetics.fandom.com/wiki/Glitter_graphics "Glitter graphics") and word art with bevel and emboss effects was also extremely common.
...
* [Internet Archive's Wayback Machine](https://archive.org/web/) - An extensive archive of historical websites.
* [Web Design Museum](https://www.webdesignmuseum.org/) - A museum that documents web design trends from 1991 to 2006.
* [Space Jam (1996)](https://www.spacejam.com/1996/) - The original promotional website for the film, preserved in its initial state.
* [Cameron's World](https://www.cameronsworld.net/) - A curated collage and archive of text and GIFs from GeoCities websites.
* [World Wide Web](https://info.cern.ch/hypertext/WWW/TheProject.html) - The first-ever website, created by Tim Berners-Lee in 1991.

## Gallery

A common web badge from the era.

GIF of a flying saucer

Best viewed with a computer

An animated GIF of the "All Your Base Are Belong to Us" meme.

A typical "Welcome to my page" GIF.

A glimpse of the YouTube interface in the mid-2000s.

An animated fire GIF, commonly used for decoration.
