...
source_url: "https://aesthetics.fandom.com/wiki/Basic_Girl"
...
Remember to check [what links here](https://aesthetics.fandom.com/wiki/Special:WhatLinksHere/Basic_Girl "Special:WhatLinksHere/Basic Girl") and [the page history](https://aesthetics.fandom.com/wiki/Basic_Girl?action=history) before deletion.  
**Reason:** This page confuses a cultural stereotype with a cohesive aesthetic. The "basic white girl" is a social cliché, not a visual style that people intentionally curate. The page's motifs are an uncurated starter pack of consumer products (Starbucks cups, Ugg boots) and mainstream media, which do not form a single, discernible aesthetic. The content is an uncritical dump of pop culture and a sociological analysis of a derogatory term, making it a stereotype dump rather than a valid aesthetic page.
...
**Reason for Warning:** This page documents a pejorative social stereotype used to ridicule and shame women for following mainstream trends. The stereotype originated with racial and gendered tones and is used as an insult. The content is presented for documentation of the social phenomenon, not to endorse shaming women for their fashion choices or interests. Viewer discretion is advised.

**Basic Girl**, also known as **Basic White Girl**, is a [stereotype](https://aesthetics.fandom.com/wiki/Stereotype "Stereotype") that originated in the early 2010s through the point of view of African-Americans and [alt](https://aesthetics.fandom.com/wiki/Alternative "Alternative") people on the average American teenage girls, primarily through riffing and observation. A Basic Girl tends to love Starbucks or Dunkin' Donuts, wear Ugg boots. This aesthetic was created through a negative view of popular trends seen mostly adopted by white teenagers and young adults, and is often used as an insult to these demographics. This aesthetic is often used by major media companies when creating female characters to make them more relatable to a larger audience.
...
Comedy Sketch circa 2017 about Basic White Girls
...
- `images/basic-girl/Bwg-iphones.jpg`
- `images/basic-girl/Bwg-dog-filter.jpg`
- `images/basic-girl/Bwg-pink-starbucks.jpg`
- `images/basic-girl/Bwg-sunflower.jpg`
- `images/basic-girl/Bwg-boots.jpg`
- `images/basic-girl/Bwg-costume.jpg`
- `images/basic-girl/Bwg-starterpack.png`
- `images/basic-girl/Bwg-selfie-top.jpg`

## Source and attribution

Text adapted from "Basic Girl" on the Aesthetics Wiki (https://aesthetics.fandom.com/wiki/Basic_Girl), licensed CC-BY-SA 4.0. Retrieved 2026-07-22. Images retain their individual licenses; see the local `credits.json`.
