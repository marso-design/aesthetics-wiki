---
name: "Japanese Horror Game Protagonist"
slug: "japanese-horror-game-protagonist"
...
_Also known as: Female Horror Game Protagonist, Grunge Coquette, Horror Coquette_

Needs Work 🛠️

This page requires improvement. Please help us by [expanding it](https://aesthetics.fandom.com/wiki/Japanese_Horror_Game_Protagonist?action=edit). If you are unsure how to help, check the article guide [Format and Content](https://aesthetics.fandom.com/wiki/Format_and_Content "Format and Content").  
**Reason:** More information needed for the fashion section.

**Japanese Horror Game Protagonist** fashion is a TikTok microtrend wherein young women create outfits inspired by the female protagonists in popular Japanese [horror](https://aesthetics.fandom.com/wiki/Horror "Horror") games, most notably the *Fatal Frame* series. The fashion is largely built upon the concurrent social media youth fashion trend, [Coquette](https://aesthetics.fandom.com/wiki/Coquette "Coquette"), specifically the [Dark Coquette](https://aesthetics.fandom.com/wiki/Dark_Nymphet "Dark Nymphet") subtype, in addition to [Grunge](https://aesthetics.fandom.com/wiki/Grunge "Grunge")/[Soft Grunge](https://aesthetics.fandom.com/wiki/Soft_Grunge "Soft Grunge") influences. It largely depends on the use of dark-colored pieces from hyper-feminine brands from Japan and generous accessories.

## Fashion

### Tops

There are multiple types of tops that fit into the aesthetic, and could lean in multiple directions. One of them uses **tops that have [Kawaii](https://aesthetics.fandom.com/wiki/Kawaii "Kawaii") details** found in Japanese fashions, especially from the brand Axes Femme. They can feature ruffles, Peter Pan collars, lace trim, and ribbons around the neck. One popular trend is the "Milkmaid Top", which is a faux two-pieces top that looks like a scoop neck combined with a contrasting lace camisole.
...
This aesthetic has a strong emphasis on socks and tights. There are many styles worn, but most common are **knee-high or above socks**, which are also related to schoolgirl uniforms.
...
* Meat Monster by Elita
* Hikikomori by Elita
* Korean Karaoke Bar by Elita
...
* Dreadout series
* IB
* Alice Madness series
* Cry of Fear
* Cineris Somnia
* Outlast
* White Day series (specifically White Day: A Labyrinth Named School)

## Gallery

Horror female protagonist outfit ✨

Horror game protagonist outfit 🖤

How to dress like you’re a horror game protagonist 🔦

Yuri Kozukata from Fatal Frame

Yuri Kozukata from Fatal Frame

Miu Hinasaki and Miku Hinasaki from Fatal Frame

Rei Kurosawa from Fatal Frame

Stella Nox Fleuret from Final Fantasy

Fiona Belli from Haunting Ground

Miu Hinasaki from Fatal Frame
...
- `images/japanese-horror-game-protagonist/Yurikozukata.png`
- `images/japanese-horror-game-protagonist/Femalehorrorgameprotag.png`
- `images/japanese-horror-game-protagonist/Stellanoxfleuret.png`
- `images/japanese-horror-game-protagonist/HeatherMason.png`

## Source and attribution

Text adapted from "Japanese Horror Game Protagonist" on the Aesthetics Wiki (https://aesthetics.fandom.com/wiki/Japanese_Horror_Game_Protagonist), licensed CC-BY-SA 4.0. Retrieved 2026-07-22. Images retain their individual licenses; see the local `credits.json`.
