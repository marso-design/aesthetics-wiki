...
_Also known as: Y2K Grunge, Military Y2K_

Needs Work 🛠️

This page requires improvement. Please help us by [expanding it](https://aesthetics.fandom.com/wiki/Cyber_Grunge?action=edit). If you are unsure how to help, check the article guide [Format and Content](https://aesthetics.fandom.com/wiki/Format_and_Content "Format and Content").  
**Reason:** This article currently functions as a contradictory "smoothie" that conflates multiple distinct aesthetics, specifically merging the Western TikTok dystopian style of Cyber Grunge with the South Korean minimalist aesthetic known as [Acubi](https://aesthetics.fandom.com/wiki/Acubi "Acubi"), alongside [Fairy Grunge](https://aesthetics.fandom.com/wiki/Fairy_Grunge "Fairy Grunge"), "Bleak Crush" (Steves Peeps micro-label), and "Laincore" ([Glitchbreak](https://aesthetics.fandom.com/wiki/Glitchbreak "Glitchbreak")/[Denpa](https://aesthetics.fandom.com/wiki/Denpa "Denpa")). A comprehensive overhaul is required to disentangle these subjects, as Acubi warrants its own page due to its origins in K-Fashion and its focus on neutral tones and "subversive basics," which stand in direct opposition to the textured and industrial appearance of true Cyber Grunge.

**Cyber Grunge** is an aesthetic that blends elements of [Grunge](https://aesthetics.fandom.com/wiki/Grunge "Grunge"), streetwear, and [Y2K Futurism](https://aesthetics.fandom.com/wiki/Y2K_Futurism "Y2K Futurism"), sometimes with slight military influences. This style, which has been observed since approximately 2022, is characterized by bold silhouettes, utilitarian features, and an infusion of futuristic elements. It largely utilizes "subversive basics," referring to simple clothing with [alternative](https://aesthetics.fandom.com/wiki/Alternative "Alternative") or [avant-garde](https://aesthetics.fandom.com/wiki/Avant-garde "Avant-garde") details such as cut-outs, mesh, and pockets. The influence of the [Y2K](https://aesthetics.fandom.com/wiki/Y2K "Y2K") revival is also prevalent, with accessories, prints, and silhouettes from that era being common.
...
* Necklaces akin to [Fairy Grunge](https://aesthetics.fandom.com/wiki/Fairy_Grunge "Fairy Grunge") (pearl, handmade, etc.)
* Stockings
...
* [Apricotcat](https://apricotcat.tumblr.com/)
* [Despar Zine](https://www.instagram.com/despar_zine/)
