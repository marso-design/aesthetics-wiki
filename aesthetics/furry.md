...
Remember to check [what links here](https://aesthetics.fandom.com/wiki/Special:WhatLinksHere/Furry "Special:WhatLinksHere/Furry") and [the page history](https://aesthetics.fandom.com/wiki/Furry?action=history) before deletion.  
**Reason:** This page is mistaking a large, diverse fandom for a singular, cohesive aesthetic. The page fails to define a cohesive visual identity, instead documenting a wide variety of styles such as "toony," "realistic," and "kemono" fursuits that are often contradictory. Furthermore, the page fails to meet the standard of neutral and rigorous documentation by presenting an idealized version of the community while glossing over or omitting its problematic aspects. The page functions as a content dump for a fandom and is redundant with what a dedicated wiki on the furry fandom would cover.
...
In many fursonas (especially older ones made pre-2010), tacky, [kitschy](https://aesthetics.fandom.com/wiki/Kitschy "Kitschy") colour combinations are seen (such as a wolf character with grey body, neon blue snout, eyes and hair, plus bright pink stripes on their body). Although this trend seems to have diminished somewhat, the preference for bright, happy colours remains, which is unsurprising, considering how many furry characters are - directly or indirectly - inspired by cartoons. Therefore, the furry fandom is often close to [Kidcore](https://aesthetics.fandom.com/wiki/Kidcore "Kidcore").

Obviously, not all furry artists have this aesthetic, and in principle virtually [any aesthetic](https://aesthetics.fandom.com/wiki/List_of_Aesthetics "List of Aesthetics") may be combined with a furry character.

## History

The furry subculture has its roots in the 1970s [underground](https://aesthetics.fandom.com/wiki/Underground "Underground") comix movement, a genre of comics of which depicted adult content.
...
Even though the Furry subculture lacks a singular musical genre, its internally produced music is predominantly rooted in electronic dance music (EDM) and internet-native microgenres. The fandom's musical output is largely distributed through independent netlabels and online platforms, reflecting the subculture's DIY and online origins.

The most prominent stylistic overlap occurs with fast-paced electronic genres such as breakcore, speedcore, and happy hardcore. This is heavily attributed to the extensive discography of the LapFox Trax (now Halley Labs) netlabel, which utilizes different anthropomorphic aliases to produce specific electronic subgenres.

Other notable musical acts within the fandom focus on orchestral arrangements, pop-rock, and folk, frequently performing at live convention events.
...
**Glamfur** was an art trend popular in the early 2000s, primarily among teenage artists on sites such as DeviantART, FurAffinity, and Livejournal, as well as on furry archival site, VCL, before its closure.

The style often features unusual anatomy and stylistic choices, such as large foreheads. Fashion inspiration is taken from several alternative fashion styles, such as goth (particularly mall goth and cybergoth), visual kei, and emo. Body modifications, both the extreme and mundane, are also common. Common thematic elements include crossdressing and LGBT+ themes, medical imagery, gore and other common horror traits, and mental illness.

Some notable artists for the style include Zeriara, Chival, Vera, Leelee Lenox and Psychodjinn. The Langurhali species, created by Vera in 2004, are also associated with the trend.

### Sparklefur / Sparkledogs

**Sparklefur** is a genre of character design that primarily focuses on animal characters with extremely saturated and unnatural colors, often multiple, as well as accessories and complex markings.

Initially, the term "sparkledog" was utilized as a derogatory term to refer to young artists' tendency to make brightly colored, often clashing or gaudy-looking, canid characters. Over time, the concept has broadened, and the term has evolved into an affectionate term used mainly by enthusiasts with an interest in these types of characters.

## Controversy

### Sexual Content and Internal Debate
...
### External Stereotypes and Misconceptions

The fandom is frequently associated with public misconceptions, particularly regarding its relationship to non-anthropomorphic animals. External media and critics often raise the stereotype that the fandom promotes or involves zoophilia (sexual interest in non-anthropomorphic animals). This claim is contradicted by social research conducted on the fandom. Studies suggest that interest in zoophilia is not more common in the Furry fandom than in the general population, and the vast majority of participants are interested only in anthropomorphic (human-like) characters.

## Resources

### Music Guide

* [RYM Ultimate Box Set > Furry Music](https://rateyourmusic.com/list/TheScientist/rym-ultimate-box-set-furry-music/)
* [What is "Furry Music"?](https://rateyourmusic.com/list/GoodnightGirl/what-is-furry-music/)

### Communities

* [Furaffinity](https://www.furaffinity.net/)
* [Kemoner](http://www.kemoner.com/) (Japanese)
* [The Furry Forums](https://www.thefurryforum.com/)

### Vendors

* [Fursuit Makers](https://fursuitreview.com/m/)
* [The Dealer's Den](https://www.thedealersden.com/)

## Gallery

Example of a furkig.

fursuit owned by @Starburst\_RS on Twitter

made by DexreousZombie on DeviantArt. Owned by Heartzoroni on FurAffinity

owned by @starpupstudio on Twitter

made by @fluffyjellydog on Twitter

owned by @jun0clawz on instagram

owned by @FurfurN7 (???) on Twitter

made by @KikiChaosC on Twitter

also made by @KikiChaosC on Twitter

owned by @sakura.dalmie on TikTok (???)

made by @KikiChaosC on Twitter

Paper fursuit head, owned by @elliott\_stuffz on TikTok

Paper fursuit head, also owned by @elliott\_stuffz on TikTok

Paper Fursuit head, again owned by @elliott\_stuffz on TikTok

owned by @sunshine\_scippy on TikTok

owned by @fluffy\_\_mei on Instagram

made by @jindypityy on Etsy

Dino Mask Fursuit Head

owned by @dragonofdruw on TikTok (??)

Protogen Fursuit. made/owned by Sophifurry on DeviantArt (??)

owned by @CoolKoinu on Twitter

owned by @CoolKoinu on Twitter (right)

Realistic Fox Fursuit. owned by @smallyuxp on Unstagram

Realistic Fursuit. made by Qarrazel

Realistic Wolf Fursuit. made by @mixedcandy on Twitter

A [Fluttershy](https://mlp.fandom.com/wiki/Fluttershy) furkig by @ayichen
