...
name: "Pokero"
slug: "pokero"
aka: ["Pokera (feminine)", "Poky (associated music genre)"]
...
_Also known as: Pokera (feminine), Poky (associated music genre)_

**Pokeros** were a working-class youth subculture from Spain that emerged in the early 2000s, distinct from but often confused with the broader "[Cani](https://aesthetics.fandom.com/wiki/Cani "Cani")/[Choni](https://aesthetics.fandom.com/wiki/Choni "Choni")" and "[Bakala](https://aesthetics.fandom.com/wiki/Bakala "Bakala")" subcultures.

The subculture is characterized by its intrinsic connection to the "Poky" music genre (a Spanish derivative of Hard House), a specific fashion style involving sportswear and gold jewelry, and a lifestyle centered around macro-discotheques in the industrial outskirts of cities like Madrid and Valencia.
...
The subculture coalesced between 2000 and 2002 as a fusion of the earlier "[Bakala](https://aesthetics.fandom.com/wiki/Bakala "Bakala")" subculture (associated with the "[Ruta del Bakalao](https://aesthetics.fandom.com/wiki/Ruta_Destroy "Ruta Destroy")" clubbing phenomenon in Valencia) and *Gitano* (Romani) aesthetics. It became heavily concentrated in the south of Madrid and the Levante region, flourishing in specific local nightclubs such as Radical, Panic, Fabrik, and KKO.
...
### Social Perception and Controversy

During their peak popularity, Pokeros were a highly polarizing figure in Spanish society and internet forum culture. Discussions from the time often characterized the group through lenses of class conflict and political tension. The subculture was frequently the target of classist ridicule, labeled as "*garrulos*" or "*[canis](https://aesthetics.fandom.com/wiki/Cani "Cani")*." Forum archives from the era often stereotyped members as lacking academic ambition or intelligence, citing high school dropout rates.

Unlike other [rave](https://aesthetics.fandom.com/wiki/Rave "Rave") subcultures that were typically apolitical or countercultural, Pokeros were often associated with Spanish nationalism. Primary sources from the era describe racist tensions between Pokeros and immigrant communities, specifically Latin American and Arab youths, which occasionally escalated into physical altercations with rival groups like the "Latin Kings."
...
By the late 2000s and early 2010s, the specific identity of the Pokero began to fade, largely assimilated into the broader and more commercially recognized "[Cani](https://aesthetics.fandom.com/wiki/Cani "Cani")" stereotype. Contemporary sources note that even during their peak, the terms were often conflated by outsiders, a confusion reflected in retrospective media where former members self-identify as "Canis" despite describing specific Pokero traits.
...
* "Flying Free" by Pont Aeri (the anthem of the era, widely adopted by Pokeros despite being [Mákina](https://aesthetics.fandom.com/wiki/M%C3%A1kina "Mákina"))
* "Lover Why" by John Wesley
* "In My Eyes" by Milk Inc.
* "Castles in the Sky" by Ian Van Dahl
* "Someday" by Divine Inspiration
* "Summer of Love" by Charisse
* "Because of You" by Sergi M
* "Talk to Me" by Head Horny's & Miguel Serna

## Gallery

A street-style profile from *La Revista 40* (c. 2009) featuring a self-identified "pokera." The accompanying text highlights the group's self-perception as "*chulos*" and "*macarras*" (cocky and street-tough).

A candid group snapshot on the Madrid Metro (c. late 2000s). This image documents the subculture's social dynamics. The subjects display the standard grooming of the era (*cenicero*/crest haircuts and high buns) and wear merchandise from Discoteca Kontrol (visible on the gas mask T-shirt), linking their identity directly to the Hard Dance club scene.

Detail of Pokera grooming: heavy gold jewelry, pencil-thin eyebrows, and facial piercings were standard status symbols.

Club scene snapshot. Note the prominent gold hoop earrings and facial piercings on the subject, as well as the 'El Niño' brand t-shirt visible in the background, a staple streetwear brand for the subculture.

A self-identified Pokera wearing a casual outfit featuring the Spanish flag. The display of national symbols (*rojigualda*) was a defining, albeit controversial, trait of the subculture that distinguished it from other rave scenes.

British soul singer Amy Winehouse. Her signature "beehive" hairstyle was widely appropriated by female Pokeras, who adopted the high bun (or "*moño*") as a standard part of their grooming routine, often exaggerated with hairpieces to achieve maximum volume.

## Videos

MiS PoKeRoS LeS AmOoH

A digital "tribute" slideshow (dated September 2008) created by a community member. The video serves as a primary source for the subculture's self-presentation. Note the "before-and-after" transition, the distinctive typographic style (alternating caps in "NuTrY PokeRiTaH"), and the prominence of branded hand fans (abanicos) from hard dance venues like Chocolate and Fabrik, which were essential accessories for the dance floor.
