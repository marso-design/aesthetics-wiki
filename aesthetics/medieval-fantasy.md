...
This page requires improvement. Please help us by [expanding it](https://aesthetics.fandom.com/wiki/Medieval_Fantasy?action=edit). If you are unsure how to help, check the article guide [Format and Content](https://aesthetics.fandom.com/wiki/Format_and_Content "Format and Content").

**Medieval Fantasy** is a subgenre of [fantasy](https://aesthetics.fandom.com/wiki/Fantasy "Fantasy"), which is "a genre of fiction set in a fictional universe." However, Medieval Fantasy is unlike normal fantasy in that it specifically pertains to or is influenced by the [Medieval](https://aesthetics.fandom.com/wiki/Medieval "Medieval") period of European history, which was from the 5th century to the 15th century.

Medieval England and influences from medieval English history are the most common, but the degree of influence varies wildly, with some borrowing from elements from the Renaissance period, most notably in the style of the weapons and armor used around that time. In recent times there has been an effort to include non-English Medieval influences.

## Visuals

The visual identity of the genre is a fantastical version of the Middle Ages. Many media would have European-inspired settings like castles, but also feature mystical beings like dragons, witches, etc.

## Fashion

Medieval Fantasy fashion are influenced by the silhouettes of the Middle Ages, but also necessarily historically accurate. Polyester stretch velvet, for example, is often used in film and television productions because of its low cost compared to natural silk velvet.
...
* Flowers in one's hair or adorned somewhere else on an outfit
...
* *Berserk* (late middle ages on the verge of early modern period)
...
* *Dungeons & Dragons* (Tabletop game, 1974)
* *Fear and Hunger* (Video game, 2018)
* *The Legend of Zelda* (Video game series, 1986-present)
* *The Elder Scrolls* (Video game series, 1994-present)

## Music

### Artists

* [Hildegard von Blingin'](https://www.youtube.com/channel/UCJ_jwWjf8u5mdtac71Be8QA) and other [Bardcore](https://aesthetics.fandom.com/wiki/Bardcore "Bardcore") music
...
* [Fell and Fair](https://www.fellandfair.shop/)
