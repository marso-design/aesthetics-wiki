...
name: "Vaporgoth"
slug: "vaporgoth"
aka: ["Deathdream", "Spookwave", "Blackvapor"]
...
_Also known as: Deathdream, Spookwave, Blackvapor_

**Vaporgoth** is a niche subgenre of [Vaporwave](https://aesthetics.fandom.com/wiki/Vaporwave "Vaporwave") that emerged in the mid-2010s, characterized by its fusion of the classic Vaporwave sound with the gloomy, oppressive atmospheres of dark ambient, [industrial](https://aesthetics.fandom.com/wiki/Industrial "Industrial"), and noise music. The aesthetic subverts Vaporwave's often melancholic or satirical nostalgia, pushing it into the realm of horror, existential dread, and technological decay.
...
Vaporgoth developed around 2015 from the more experimental corners of the Vaporwave scene on platforms like Bandcamp. Artists began to strip away the melodic, pop-oriented, and often upbeat elements of popular subgenres like [Future Funk](https://aesthetics.fandom.com/wiki/Future_Funk "Future Funk"), focusing instead on Vaporwave's potential for creating dark and unsettling atmospheres.
...
The visual style of Vaporgoth directly mirrors its dark and distorted sound. The aesthetic is presented through album covers and online imagery that is dark, cryptic, and often inspired by horror. Common visual elements include heavy use of [Glitch Art](https://aesthetics.fandom.com/wiki/Glitch_Art "Glitch Art"), distorted or corrupted digital images, and a stark, monochromatic color palette of black and white, sometimes accented with muted digital blues or greens. The imagery often plays on themes of technological decay, surveillance, and the uncanny, creating a visual experience that is as unsettling as the music itself.
...
Unlike the layered sampling of classic [Vaporwave](https://aesthetics.fandom.com/wiki/Vaporwave "Vaporwave"), Vaporgoth's sample editing is often more minimalistic and obscure. Songs are frequently unstructured and can be either very short (under two minutes) or very long (over ten minutes), creating an unpredictable and disorienting listening experience. The music often incorporates samples from films or other media to create a harsh or creepy sonic texture, with the overall goal being the creation of a dark, ambient, and horror-inspired mood.

### Artists

* Chinese Hackers
* HKE (under aliases like The Darkest Future and チェスマスター)
* VVVX Software
* 骨架的 (skeleton)
* .mp3Neptune
* Humanfobia
...
* "░▒▓死▓▒░" by Chinese Hackers
* "wiretrap" by Chinese Hackers
* "????????" by The Darkest Future
* "White Death" by 아버지 [father]
* "Empty Faces in Digital Spaces" by .mp3Neptune
* "Carrie White Burns in Hell (B-sides)" by Humanfobia
* "Mana Tech" by Boseby
* “SSTV Coverage” by International Telecom

## Gallery

Cover art for "??????????? ・ Recovery ・ ララバイデータベース" by Astro TV System / 空気系 [Slice of Life] / 天気予報 [Weather Forecast]

Cover art for "Deepfall" by Diskette Park

Cover art for "Cultivation of the Flesh" by チェスマスター [Chessmaster]

Cover art for "デッドデッドデッドデッド [Dead Dead Dead Dead]" by Vision Girl

Cover art for "p u r i t y" by /// p r i m o r d i a l ///

Cover art for "⌖ Ｗ≋Ｔ Ｐ∆ＬＭＳ ⌖" by ＬＥＶＩＡＴＨＡＮ－リバイアサン ＇９６

Cover art for "La fin de la ligne" by Sacred Frequencies

Cover art for "SCARYパンプキン" by Various Artists

Cover art for "Blackburn" by Scenebuild

Cover art for "The Darkest Future" by ????????

Cover art for "Wiretap" by Chinese Hackers.

Cover art for "Ｖｉｒｔｕａｌ Ｅａｒｔｈ" by ＶＶＶＸ Ｓｏｆｔｗａｒｅ

cover art for "Carrie White Burns in Hell (B-sides)" by Humanfobia

Cover art for "Mana Tech" by Boseby
...
| Fusion & Inspired |
| [Barber Beats](https://aesthetics.fandom.com/wiki/Barber_Beats "Barber Beats") ✪ [Future Funk](https://aesthetics.fandom.com/wiki/Future_Funk "Future Funk") ✪ [Dreampunk](https://aesthetics.fandom.com/wiki/Dreampunk "Dreampunk") ✪ **Vaporgoth** ✪ [Simpsonwave](https://aesthetics.fandom.com/wiki/Simpsonwave "Simpsonwave") |
| Conceptual |
