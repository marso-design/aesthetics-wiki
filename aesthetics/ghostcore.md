...
source_url: "https://aesthetics.fandom.com/wiki/Ghostcore"
...
This page requires improvement. Please help us by [expanding it](https://aesthetics.fandom.com/wiki/Ghostcore?action=edit). If you are unsure how to help, check the article guide [Format and Content](https://aesthetics.fandom.com/wiki/Format_and_Content "Format and Content").
...
* [Victorian](https://aesthetics.fandom.com/wiki/Victorian "Victorian") paintings
* Mansions or castles
* White out eyes or pitch black eyes
* White sheets
...
* Visiting a haunted house or graveyard
* Performing a seance

## Fashion

Ghostcore fashion can be open to the interpretation and comfort to any individual, as this is not a fashion-centric aesthetic. There can be overlap with aesthetics like [Gothic](https://aesthetics.fandom.com/wiki/Gothic "Gothic") and [Morute](https://aesthetics.fandom.com/wiki/Morute "Morute"). However, the community has been open in discussing various fashion tastes and intrigues which include:

* Flowing, lightweight gowns and fabrics
  + Typically in white or black
* Suits and formalwear as if attending a funeral
* [Vintage](https://aesthetics.fandom.com/wiki/Vintage "Vintage") and Victorian-esque fashions
* Hoodies
* White sheets
* Vintage nightgowns
...
* I Spy Spooky Mansion Wii (2010)
* Nancy Drew: Message in a Haunted Mansion (2000)
* Nancy Drew: Ghost of Thornton Hall (2013)
* Nancy Drew: Midnight In Salem (2020)
* Poptropica: Ghost Story Island
...
* [*r/ghost*](https://www.reddit.com/r/Ghosts/)
* [*r/nosleep*](https://www.reddit.com/r/nosleep/)
* [*r/horror*](https://www.reddit.com/r/horror/)

#### Tumblr

* [/ghostcore](https://www.tumblr.com/search/ghostcore)
* *[Sleeping in the Mausoleum](https://cobblestone-ghost.tumblr.com/post/646379274982621184)*
* *[Sorry to be ghosted](https://that-shadow-in-the-back.tumblr.com/post/646315338756161536/theres-something-about-fog-that-makes-me)*
* *[Hi](https://fettfleisch.tumblr.com/)*
* *[Good old-fashioned abditory](https://phantasmagothic.tumblr.com/)*
* *[creep shit](https://teenlore.tumblr.com/)*
...
- `images/ghostcore/Eyes.jpg`
- `images/ghostcore/Hmm.jpg`
- `images/ghostcore/Yoshiki.jpg`
- `images/ghostcore/Kids.jpg`
- `images/ghostcore/Mirror.jpg`
- `images/ghostcore/Coven.jpg`
- `images/ghostcore/Huh.jpg`
- `images/ghostcore/Ghost-gaurdian.jpg`
- `images/ghostcore/Ghost-painting.jpg`
- `images/ghostcore/Ghost-roof.jpg`
- `images/ghostcore/Ghost-sheet.jpg`

## Source and attribution

Text adapted from "Ghostcore" on the Aesthetics Wiki (https://aesthetics.fandom.com/wiki/Ghostcore), licensed CC-BY-SA 4.0. Retrieved 2026-07-22. Images retain their individual licenses; see the local `credits.json`.
